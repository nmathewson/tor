...
test_hs_ntor(void *arg)
{
    ...
    retval = hs_ntor_client_get_introduce1_keys(
        ...
        &client_ephemeral_enc_keypair, &subcredential, &client_hs_ntor_intro_cell_keys);
    ...
    retval = hs_ntor_service_get_introduce1_keys(
        ...
        &client_ephemeral_enc_keypair.pubkey, &subcredential, &service_hs_ntor_intro_cell_keys);
    tt_int_op(retval, OP_EQ, 0);
    ...
    retval = hs_ntor_client_get_rendezvous1_keys(
        ...
        &service_intro_enc_keypair.pubkey, &service_ephemeral_rend_keypair.pubkey,
...
struct testcase_t hs_ntor_tests[] = {{"hs_ntor", test_hs_ntor, TT_FORK, NULL, NULL},
