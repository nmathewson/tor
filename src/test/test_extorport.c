...
test_ext_or_cookie_auth(void *arg)
{
    ...
    crypto_hmac_sha256(hmac1, (char *)ext_or_auth_cookie, 32,
                       server_hash_input, 46 + 32 + 32);
    crypto_hmac_sha256(hmac2, (char *)ext_or_auth_cookie, 32,
                       client_hash_input, 46 + 32 + 32);
    ...
    tt_int_op(0, OP_EQ,
              handle_client_auth_nonce(client_nonce, 32, &client_hash2,
                                       &reply2, &reply_len));
