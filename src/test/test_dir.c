 ...
 */
static routerinfo_t *
basic_routerinfo_new(const char *nickname, uint32_t ipv4_addr, uint16_t or_port,
                     uint16_t dir_port, uint32_t bandwidthrate,
                     uint32_t bandwidthburst, uint32_t bandwidthcapacity,
    ...
    switch (idx) {
        ...
        case 2:
            ...
            rs->is_authority = rs->is_exit = rs->is_stable = rs->is_fast =
                rs->is_flagged_running = rs->is_valid = rs->is_possible_guard =
                    1;
            /*
...
test_dir_dump_unparseable_descriptors(void *data)
{
    ...
    const char *test_desc_1 = "The most merciful thing in the world, I think, "
                              ...
                              "from the revelation or flee from the light into "
    ...
    const char *test_desc_4 = "So we glanced back simultaneously, it would "
                              ...
                              "so we flashed both torches full strength at the "
                              "momentarily thinned mis"
                              ...
                              "re dearly for a backward glance. And again came "
                              "that shocking, wide-ran"
