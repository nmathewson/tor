...
static const char simple_settings[] = "s this is a \n"
...
static const badval_test_t bv_big_interval = {"interval 1000 months", "too large"};
...
test_confparse_list_vars(void *arg)
{
    ...
    tt_assert(vars);
    SMARTLIST_FOREACH(vars, config_var_t *, cv, smartlist_add(varnames, (void *)cv->member.name));
