...
static int
mock_crypto_pk_public_checksig__nocheck(const crypto_pk_t *env, char *to, size_t tolen,
...
static int
mock_crypto_pk_public_checksig_digest__nocheck(crypto_pk_t *env, const char *data, size_t datalen,
...
static int
mock_ed25519_checksig__nocheck(const ed25519_signature_t *signature, const uint8_t *msg, size_t len,
...
static int
mock_ed25519_checksig_batch__nocheck(int *okay_out, const ed25519_checkable_t *checkable,
                                     int n_checkable)
{
