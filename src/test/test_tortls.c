...
static tor_x509_cert_impl_t *fixed_try_to_extract_certs_from_tls_cert_out_result = NULL;
static tor_x509_cert_impl_t *fixed_try_to_extract_certs_from_tls_id_cert_out_result = NULL;

static void
fixed_try_to_extract_certs_from_tls(int severity, tor_tls_t *tls, tor_x509_cert_impl_t **cert_out,
                                    tor_x509_cert_impl_t **id_cert_out)
{
    (void)severity;
    (void)tls;
    *cert_out = tor_x509_cert_impl_dup_(fixed_try_to_extract_certs_from_tls_cert_out_result);
    *id_cert_out = tor_x509_cert_impl_dup_(fixed_try_to_extract_certs_from_tls_id_cert_out_result);
}
...
test_tortls_tor_tls_get_error(void *data)
{
    ...
    tor_tls_get_error(tls, 0, 0, (const char *)"in unit test", LOG_WARN, LD_GENERAL);
...
test_tortls_verify(void *ignored)
{
    ...
    tor_tls_t *tls;
    crypto_pk_t *k = NULL;
    tor_x509_cert_impl_t *cert1 = NULL, *cert2 = NULL, *invalidCert = NULL, *validCert = NULL,
                         *caCert = NULL;
...
struct testcase_t tortls_tests[] = {LOCAL_TEST_CASE(errno_to_tls_error, 0),
