...
test_gen_establish_intro_cell(void *arg)
{
    ...
    /* Parse it as the receiver */
    {
        ...
        ret = verify_establish_intro_cell(cell_in, (const uint8_t *)circ_nonce, sizeof(circ_nonce));
...
static int
mock_ed25519_sign_prefixed(ed25519_signature_t *signature_out, const uint8_t *msg, size_t msg_len,
...
test_gen_establish_intro_dos_ext(void *arg)
{
    ...
    const trn_cell_extension_field_t *field = trn_cell_extension_getconst_fields(extensions, 0);
    ...
    /* Rate per sec param. */
    const trn_cell_extension_dos_param_t *param = trn_cell_extension_dos_getconst_params(dos, 0);
...
struct testcase_t hs_cell_tests[] = {
    {"gen_establish_intro_cell", test_gen_establish_intro_cell, TT_FORK, NULL, NULL},
    {"gen_establish_intro_cell_bad", test_gen_establish_intro_cell_bad, TT_FORK, NULL, NULL},
    {"gen_establish_intro_dos_ext", test_gen_establish_intro_dos_ext, TT_FORK, NULL, NULL},
