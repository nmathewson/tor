...
test_util_format_unaligned_accessors(void *ignored)
{
    ...
    tt_u64_op(get_uint64(buf + 1), OP_EQ, tor_htonll(UINT64_C(0x6e696f6e736f7570)));
...
test_util_format_encoded_size(void *arg)
{
    ...
    for (i = 0; i <= sizeof(inbuf); ++i) {
        ...
        base64_encode(outbuf, sizeof(outbuf), (char *)inbuf, i, BASE64_ENCODE_MULTILINE);
        tt_int_op(strlen(outbuf), OP_EQ, base64_encode_size(i, BASE64_ENCODE_MULTILINE));
        tt_int_op(i, OP_LE, base64_decode_maxsize(strlen(outbuf)));
    }
...
struct testcase_t util_format_tests[] = {
    {"unaligned_accessors", test_util_format_unaligned_accessors, 0, NULL, NULL},
    {"base64_encode", test_util_format_base64_encode, 0, NULL, NULL},
    {"base64_decode_oddsize", test_util_format_base64_decode_oddsize, 0, NULL, NULL},
