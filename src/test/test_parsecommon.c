...
test_parsecommon_tokenize_string_null(void *arg)
{
    ...
    int retval = tokenize_string(area, str_with_null, str_with_null + 3, tokens, NULL, 0);
...
test_parsecommon_get_next_token_object(void *arg)
{
    ...
    const char *str = "directory-signature 0232AF901C31A04EE9848595AF9BB7620D4C5B2E "
    ...
    const char *end = str + strlen(str);
    const char **s = &str;
    token_rule_t rule = T("directory-signature", K_DIRECTORY_SIGNATURE, GE(2), NEED_OBJ);
    (void)arg;
    ...
    char decoded[256];
    const char *signature = "dLTbc1Lad/OWKBJhA/dERzDHumswTAzBFAWAz2vnQhLsebs1SOm0W/vceEsiEkiF\n"
                            "A+JJSzIyfywJc6Mnk7aKMEIFjOO/MaxuAp4zv+q+JonJkF0ExjMqvKR0D6pSFmfN\n"
                            "cnemnxGHxNuPDnKl0imbWKmWDsHtwgi4zWeTq3MekfMOXKi6gIh+bDFzCs9/Vquh\n"
                            "uNKJI1jW/A2DEKeaSAODEv9VoCsYSvbVVEuHCBWjeNAurd5aL26BrAolW6m7pkD6\n"
                            "I+cQ8dQG6Wa/Zt6gLXtBbOP2o/iDI7ahDP9diNkBI/rm4nfp9j4piTwsqpi7xz9J\n"
...
struct testcase_t parsecommon_tests[] = {PARSECOMMON_TEST(tokenize_string_null),
