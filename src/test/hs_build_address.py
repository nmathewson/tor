...
if hasattr(hashlib, "sha3_256"):
    ...
    # Python 3.6+, the SHA3 is available in hashlib natively. Else this
    # requires the pysha3 package (pip install pysha3).
    import sha3
...
if TEST_VALUE != sha3_256(b"Hello World").hexdigest():
...
PUBKEY = codecs.decode("d75a980182b10ab7d54bfed3c964073a0ee172f3daa62325af021a68f707511a", "hex")
# Version 3 is proposal224
VERSION = 3

data = struct.pack('15s32sb', PREFIX, PUBKEY, VERSION)
checksum = sha3_256(data).digest()
