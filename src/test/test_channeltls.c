...
static or_connection_t *tlschan_connection_or_connect_mock(const tor_addr_t *addr, uint16_t port,
                                                           const char *digest,
...
test_channeltls_create(void *arg)
{
    ...
    channel_t *ch = NULL;
    const char test_digest[DIGEST_LEN] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
...
tlschan_connection_or_connect_mock(const tor_addr_t *addr, uint16_t port, const char *digest,
...
struct testcase_t channeltls_tests[] = {
    ...
    {"num_bytes_queued", test_channeltls_num_bytes_queued, TT_FORK, NULL, NULL},
    {"overhead_estimate", test_channeltls_overhead_estimate, TT_FORK, NULL, NULL},
    END_OF_TESTCASES};
