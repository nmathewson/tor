...
test_e2e_rend_circuit_setup_legacy(void *arg)
{
     ...
     *  established to the hidden service, and then we complete the circuit
...
test_e2e_rend_circuit_setup(void *arg)
{
     ...
     * the end-to-end cpath was setup correctly and that the stream was attached
...
test_client_pick_intro(void *arg)
{
     ...
     *    nothing is returned. */
    {
                                ...
                                hs_desc_intro_point_t *, ip)
        {
             ...
             */
            if (intro_ei == NULL) {
                /* Pretend we're making a direct connection, and that we can use
                 * IPv6
                 */
            ...
            if (intro_ei) {
                ...
                ptr = tor_addr_to_str(ip_addr, &intro_ei->addr, sizeof(ip_addr),
                                      1);
