...
{
    unsigned i;
    for (i = 0; i < ARRAY_LENGTH(fixed_tor_tls_create_certificate_result);
         ++i) {
...
{
    (void)x509_cert;
    tor_x509_cert_t **certp = &fixed_tor_x509_cert_new_result
...
test_tortls_context_new(void *ignored)
{
    ...
    fixed_tor_tls_create_certificate_result[2] = X509_new();
    fixed_tor_x509_cert_new_result_index = 0;
    fixed_tor_x509_cert_new_result[0] =
    ...
    fixed_tor_x509_cert_new_result[0] =
        tor_malloc_zero(sizeof(tor_x509_cert_t));
    fixed_tor_x509_cert_new_result[1] =
        tor_malloc_zero(sizeof(tor_x509_cert_t));
    fixed_tor_x509_cert_new_result[2] = NULL;
    ret = tor_tls_context_new(NULL, 0, 0, 0);
    tt_assert(!ret);
    ...
    fixed_tor_x509_cert_new_result[1] =
        tor_malloc_zero(sizeof(tor_x509_cert_t));
    fixed_tor_x509_cert_new_result[2] =
        tor_malloc_zero(sizeof(tor_x509_cert_t));
    ret = tor_tls_context_new(NULL, 0, 0, 0);
    tt_assert(!ret);
