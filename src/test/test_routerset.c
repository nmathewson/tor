...
test_rset_refresh_geoip_not_loaded(void *arg)
{
    ...
    MOCK(geoip_get_n_countries, rset_refresh_geoip_not_loaded_geoip_get_n_countries);
...
test_rset_refresh_one_valid_country(void *arg)
{
    ...
    MOCK(geoip_get_n_countries, rset_refresh_one_valid_country_geoip_get_n_countries);
...
test_rset_refresh_one_invalid_country(void *arg)
{
    ...
    MOCK(geoip_get_n_countries, rset_refresh_one_invalid_country_geoip_get_n_countries);
...
static addr_policy_t *rset_parse_policy_wildcard_parse_item_from_string(const char *s,
                                                                        int assume_action,
                                                                        int *malformed_list);
...
test_rset_parse_policy_wildcard(void *arg)
{
    ...
    tt_int_op(rset_parse_policy_wildcard_parse_item_from_string_called, OP_EQ, 1);
...
addr_policy_t *
rset_parse_policy_wildcard_parse_item_from_string(const char *s, int assume_action,
                                                  int *malformed_list)
{
    (void)s;
    (void)assume_action;
...
static addr_policy_t *rset_parse_policy_ipv4_parse_item_from_string(const char *s,
                                                                    int assume_action, int *bogus);
...
test_rset_parse_policy_ipv4(void *arg)
{
    ...
    MOCK(router_parse_addr_policy_item_from_string, rset_parse_policy_ipv4_parse_item_from_string);
...
addr_policy_t *
rset_parse_policy_ipv4_parse_item_from_string(const char *s, int assume_action, int *bogus)
{
    (void)s;
    (void)assume_action;
...
static addr_policy_t *rset_parse_policy_ipv6_parse_item_from_string(const char *s,
...
test_rset_parse_policy_ipv6(void *arg)
{
    ...
    MOCK(router_parse_addr_policy_item_from_string, rset_parse_policy_ipv6_parse_item_from_string);
...
addr_policy_t *
rset_parse_policy_ipv6_parse_item_from_string(const char *s, int assume_action, int *bad)
{
    (void)s;
    (void)assume_action;
...
static addr_policy_result_t rset_contains_addr_cmp_addr_to_policy(const tor_addr_t *addr,
                                                                  uint16_t port,
...
static addr_policy_result_t rset_contains_no_addr_cmp_addr_to_policy(const tor_addr_t *addr,
                                                                     uint16_t port,
                                                                     const smartlist_t *policy);
...
test_rset_contains_no_addr(void *arg)
{
    ...
    MOCK(compare_tor_addr_to_addr_policy, rset_contains_no_addr_cmp_addr_to_policy);
...
static addr_policy_result_t rset_contains_null_addr_cmp_addr_to_policy(const tor_addr_t *addr,
                                                                       uint16_t port,
                                                                       const smartlist_t *policy);
...
test_rset_contains_null_addr(void *arg)
{
    ...
    MOCK(compare_tor_addr_to_addr_policy, rset_contains_null_addr_cmp_addr_to_policy);
...
addr_policy_result_t
rset_contains_null_addr_cmp_addr_to_policy(const tor_addr_t *addr, uint16_t port,
                                           const smartlist_t *policy)
{
    (void)port;
    (void)policy;
...
static addr_policy_result_t rset_countries_no_geoip_cmp_addr_to_policy(const tor_addr_t *addr,
                                                                       uint16_t port,
                                                                       const smartlist_t *policy);
static int rset_countries_no_geoip_cmp_addr_to_policy_called = 0;
static int rset_countries_no_geoip_geoip_get_country_by_addr(const tor_addr_t *addr);
...
test_rset_countries_no_geoip(void *arg)
{
    ...
    MOCK(compare_tor_addr_to_addr_policy, rset_countries_no_geoip_cmp_addr_to_policy);
    ...
    tt_int_op(rset_countries_no_geoip_geoip_get_country_by_addr_called, OP_EQ, 1);

done:;
}

addr_policy_result_t
rset_countries_no_geoip_cmp_addr_to_policy(const tor_addr_t *addr, uint16_t port,
                                           const smartlist_t *policy)
{
    (void)port;
    (void)policy;
...
static addr_policy_result_t rset_countries_geoip_cmp_addr_to_policy(const tor_addr_t *addr,
                                                                    uint16_t port,
                                                                    const smartlist_t *policy);
static int rset_countries_geoip_cmp_addr_to_policy_called = 0;
static int rset_countries_geoip_geoip_get_country_by_addr(const tor_addr_t *addr);
...
test_rset_countries_geoip(void *arg)
{
    ...
    MOCK(compare_tor_addr_to_addr_policy, rset_countries_geoip_cmp_addr_to_policy);
    MOCK(geoip_get_country_by_addr, rset_countries_geoip_geoip_get_country_by_addr);
...
static const node_t *rset_get_all_l_no_nodes_node_get_by_nickname(const char *nickname,
                                                                  unsigned flags);
...
static const node_t *rset_get_all_l_not_running_node_get_by_nickname(const char *nickname,
                                                                     unsigned flags);
...
struct testcase_t routerset_tests[] = {
    ...
    {"contains_countries_no_geoip", test_rset_countries_no_geoip, TT_FORK, NULL, NULL},
    {"contains_countries_geoip", test_rset_countries_geoip, TT_FORK, NULL, NULL},
