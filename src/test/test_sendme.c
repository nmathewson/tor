...
test_v1_consensus_params(void *arg)
{
    ...
    /* Both zeroes. */
    smartlist_add(current_md_consensus->net_params, (void *)"sendme_emit_min_version=0");
    smartlist_add(current_md_consensus->net_params, (void *)"sendme_accept_min_version=0");
    tt_int_op(get_emit_min_version(), OP_EQ, 0);
    tt_int_op(get_accept_min_version(), OP_EQ, 0);
    smartlist_clear(current_md_consensus->net_params);

    /* Both ones. */
    smartlist_add(current_md_consensus->net_params, (void *)"sendme_emit_min_version=1");
    smartlist_add(current_md_consensus->net_params, (void *)"sendme_accept_min_version=1");
...
test_package_payload_len(void *arg)
{
    ...
    tt_assert(!c->have_sent_sufficiently_random_cell);
    tt_int_op(c->send_randomness_after_n_cells, OP_GE, CIRCWINDOW_INCREMENT / 2 - 1);
...
struct testcase_t sendme_tests[] = {
    ...
    {"cell_version_validation", test_cell_version_validation, TT_FORK, NULL, NULL},
