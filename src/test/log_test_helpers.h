...
#    define expect_log_msg_containing_either3(str1, str2, str3) \
        assert_log_predicate(                                   \
            ...
            ("expected log to contain \"%s\" or \"%s\" or \"%s\"", str1, str2, str3))
...
#    define expect_log_entry() \
        assert_log_predicate(mock_saved_log_has_entry(), ("expected log to contain entries"))

#    define expect_no_log_entry() \
        assert_log_predicate(!mock_saved_log_has_entry(), ("expected log to not contain entries"))
