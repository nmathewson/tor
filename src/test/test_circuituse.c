...
struct testcase_t circuituse_tests[] = {
    {"marked",
     test_circuit_is_available_for_use_ret_false_when_marked_for_close, TT_FORK,
     NULL, NULL},
    {"timestamp",
    ...
    {"clean",
     ...
     TT_FORK, NULL, NULL},
    {"onehop",
     test_circuit_is_available_for_use_returns_false_for_onehop_tunnel, TT_FORK,
     NULL, NULL},
    {"clean_circ",
    ...
    {"exit_t", test_needs_exit_circuits_ret_true_for_predicted_ports_and_path,
     TT_FORK, NULL, NULL},
    {"non_exit", test_needs_exit_circuits_ret_false_for_non_exit_consensus_path,
     TT_FORK, NULL, NULL},
