...
test_parse_guardfraction_consensus(void *arg)
{
    ...
    const char *guardfraction_str_bad2 =
...
test_should_apply_guardfraction(void *arg)
{
    ...
    { /* Fill the votes for later */
        ...
        smartlist_split_string(vote_enabled.net_params, "UseGuardFraction=1",
                               NULL, 0, 0);
        ...
        smartlist_split_string(vote_missing.net_params, "leon=trout", NULL, 0,
                               0);
    }
...
struct testcase_t guardfraction_tests[] = {
    {"parse_guardfraction_file_bad", test_parse_guardfraction_file_bad, TT_FORK,
     NULL, NULL},
