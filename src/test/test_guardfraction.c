...
gen_vote_routerstatus_for_tests(const char *digest_in_hex, int is_guard)
{
    ...
    { /* Useful information for tests */
        ...
        retval = base16_decode(digest_tmp, sizeof(digest_tmp), digest_in_hex, HEX_DIGEST_LEN);
...
test_parse_guardfraction_file_bad(void *arg)
{
    ...
    tor_asprintf(&guardfraction_bad, "guardfraction-file-version 1\n"
                                     "written-at not_date\n"
                                     "n-inputs 420 3\n"
                                     "guard-seen D0EDB47BEAD32D26D0A837F7D5357EC3AD3B8777 100 420\n"
                                     "guard-seen 07B5547026DF3E229806E135CFA8552D56AFBABC 5 420\n");
...
test_parse_guardfraction_file_good(void *arg)
{
    ...
    retval = dirserv_read_guardfraction_file_from_str(guardfraction_good, routerstatuses);
    tt_int_op(retval, OP_EQ, 1);
    ...
    { /* Test that routerstatus fields got filled properly */
        ...
        tt_int_op(vrs_guard->status.guardfraction_percentage, OP_EQ, guardfraction_value);
...
test_parse_guardfraction_consensus(void *arg)
{
    ...
    { /* Properly formatted GuardFraction. Check that it gets applied
        ...
        retval = routerstatus_parse_guardfraction(guardfraction_str_good, NULL, NULL, &rs_good);
        tt_int_op(retval, OP_EQ, 0);
    ...
    { /* Properly formatted GuardFraction but router is not a
        ...
        retval = routerstatus_parse_guardfraction(guardfraction_str_good, NULL, NULL, &rs_no_guard);
        tt_int_op(retval, OP_EQ, 0);
    ...
    { /* Bad GuardFraction. Function should fail and not apply. */
        ...
        retval = routerstatus_parse_guardfraction(guardfraction_str_bad1, NULL, NULL, &rs_bad1);
        tt_int_op(retval, OP_EQ, -1);
    ...
    { /* Bad GuardFraction. Function should fail and not apply. */
        ...
        retval = routerstatus_parse_guardfraction(guardfraction_str_bad2, NULL, NULL, &rs_bad2);
        tt_int_op(retval, OP_EQ, -1);
...
test_should_apply_guardfraction(void *arg)
{
    ...
    { /* Fill the votes for later */
        ...
        smartlist_split_string(vote_enabled.net_params, "UseGuardFraction=1", NULL, 0, 0);
        ...
        smartlist_split_string(vote_disabled.net_params, "UseGuardFraction=0", NULL, 0, 0);
...
struct testcase_t guardfraction_tests[] = {
    {"parse_guardfraction_file_bad", test_parse_guardfraction_file_bad, TT_FORK, NULL, NULL},
    {"parse_guardfraction_file_good", test_parse_guardfraction_file_good, TT_FORK, NULL, NULL},
    {"parse_guardfraction_consensus", test_parse_guardfraction_consensus, TT_FORK, NULL, NULL},
    {"get_guardfraction_bandwidth", test_get_guardfraction_bandwidth, TT_FORK, NULL, NULL},
    {"should_apply_guardfraction", test_should_apply_guardfraction, TT_FORK, NULL, NULL},
