...
char *consensus_diff_generate(const char *cons1, size_t cons1len, const char *cons2,
                              size_t cons2len);
char *consensus_diff_apply(const char *consensus, size_t consensus_len, const char *diff,
                           size_t diff_len);
...
STATIC smartlist_t *consdiff_gen_diff(const smartlist_t *cons1, const smartlist_t *cons2,
                                      const consensus_digest_t *digests1,
                                      const consensus_digest_t *digests2, struct memarea_t *area);
STATIC char *consdiff_apply_diff(const smartlist_t *cons1, const smartlist_t *diff,
                                 const consensus_digest_t *digests1);
STATIC int consdiff_get_digests(const smartlist_t *diff, char *digest1_out, char *digest2_out);
...
STATIC smartlist_t *gen_ed_diff(const smartlist_t *cons1, const smartlist_t *cons2,
                                struct memarea_t *area);
STATIC smartlist_t *apply_ed_diff(const smartlist_t *cons1, const smartlist_t *diff,
                                  int start_line);
STATIC void calc_changes(smartlist_slice_t *slice1, smartlist_slice_t *slice2, bitarray_t *changed1,
                         bitarray_t *changed2);
...
STATIC int *lcs_lengths(const smartlist_slice_t *slice1, const smartlist_slice_t *slice2,
                        int direction);
...
STATIC void set_changed(bitarray_t *changed1, bitarray_t *changed2, const smartlist_slice_t *slice1,
                        const smartlist_slice_t *slice2);
STATIC int consensus_split_lines(smartlist_t *out, const char *s, size_t len,
                                 struct memarea_t *area);
STATIC void smartlist_add_linecpy(smartlist_t *lst, struct memarea_t *area, const char *s);
...
MOCK_DECL(STATIC int, consensus_compute_digest_as_signed,
          (const char *cons, size_t len, consensus_digest_t *digest_out));
MOCK_DECL(STATIC int, consensus_digest_eq, (const uint8_t *d1, const uint8_t *d2));
