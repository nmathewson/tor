                             ...
                             const char *service_id)
{
    ...
    SMARTLIST_FOREACH_BEGIN (desc->intro_nodes, rend_intro_point_t *, intro) {
        ...
        if (found) {
            ...
            digestmap_set(new_entry->intro_failures, (char *)identity,
                          ent_dup);
...
rend_cache_store_v2_desc_as_dir(const char *desc)
{
    ...
    tor_assert(rend_cache_v2_dir);
    tor_assert(desc);
    while (rend_parse_v2_service_descriptor(
               &parsed, desc_id, &intro_content, &intro_size, &encoded_size,
        ...
        if (parsed->timestamp <
            now - REND_CACHE_MAX_AGE - REND_CACHE_MAX_SKEW) {
        ...
        if (rend_data->auth_type != REND_NO_AUTH &&
            ...
            if (rend_decrypt_introduction_points(
                ...
                log_warn(LD_REND,
                         ...
                         "probably unable to parse the encoded introduction "
                         "points.");
            } else {
