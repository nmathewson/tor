...
struct rend_intro_cell_t {
    ...
    union {
        ...
        struct {
            ...
            /* Auth data */
            uint8_t *auth_data;
            /* Rendezvous point's IP address/port, identity digest and onion
             * key */
            extend_info_t *extend_info;
        } v3;
    } u;
...
typedef struct rend_service_t {
    ...
    rend_auth_type_t auth_type; /**< Client authorization type or 0 if no
                                 * client authorization is performed. */
     ...
     * when they do, this keeps us from launching multiple simultaneous
     * attempts to connect to the same rend point. */
