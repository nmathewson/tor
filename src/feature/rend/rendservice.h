...
struct hs_opts_t;
int rend_config_service(const struct hs_opts_t *hs_opts, const or_options_t *options,
...
int rend_service_intro_established(origin_circuit_t *circuit, const uint8_t *request,
                                   size_t request_len);
void rend_service_rendezvous_has_opened(origin_circuit_t *circuit);
int rend_service_receive_introduction(origin_circuit_t *circuit, const uint8_t *request,
                                      size_t request_len);
...
rend_intro_cell_t *rend_service_begin_parse_intro(const uint8_t *request, size_t request_len,
                                                  uint8_t type, char **err_msg_out);
int rend_service_parse_intro_plaintext(rend_intro_cell_t *intro, char **err_msg_out);
ssize_t rend_service_encode_establish_intro_cell(char *cell_body_out, size_t cell_body_out_len,
...
rend_service_port_config_t *rend_service_parse_port_config(const char *string, const char *sep,
                                                           char **err_msg_out);
...
void directory_post_to_hs_dir(rend_service_descriptor_t *renddesc, smartlist_t *descs,
