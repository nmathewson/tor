...
int rend_cache_store_v2_desc_as_client(const char *desc, const char *desc_id_base32,
                                       const rend_data_t *rend_query, rend_cache_entry_t **entry);
size_t rend_cache_get_total_allocation(void);

bool rend_cache_intro_failure_exists(const char *service_id, const uint8_t *intro_identity);
void rend_cache_intro_failure_note(rend_intro_point_failure_t failure, const uint8_t *identity,
...
#    define rend_cache_failure_intro_entry_free(e) \
        FREE_AND_NULL(rend_cache_failure_intro_t, rend_cache_failure_intro_entry_free_, (e))
...
STATIC int cache_failure_intro_lookup(const uint8_t *identity, const char *service_id,
...
STATIC void cache_failure_intro_add(const uint8_t *identity, const char *service_id,
