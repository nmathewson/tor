...
node_t *node_get_mutable_by_ed25519_id(const struct ed25519_public_key_t *ed_id);
MOCK_DECL(const node_t *, node_get_by_ed25519_id, (const struct ed25519_public_key_t *ed_id));
...
MOCK_DECL(const struct ed25519_public_key_t *, node_get_ed25519_id, (const node_t *node));
...
MOCK_DECL(smartlist_t *, node_get_link_specifier_smartlist, (const node_t *node, bool direct_conn));
