 ...
 */
was_router_added_t
router_add_to_routerlist(routerinfo_t *router, const char **msg, int from_cache,
                         int from_fetch)
{
                                             ...
                                             int hi, digestset_t *retain)
{
    ...
    if (n_rmv < n_extra) {
         ...
         * the duration of liveness, and remove the ones we're not already going
         *to remove based on how long they were alive.
         **/
    ...
    SMARTLIST_FOREACH_BEGIN(routers, routerinfo_t *, ri)
    {
        ...
        if (requested_fingerprints) {
            ...
            if (smartlist_contains_string(requested_fingerprints, fp)) {
                ...
                char *requested = smartlist_join_strings(requested_fingerprints,
                                                         " ", 0, NULL);
                log_warn(
                    LD_DIR,
            ...
            if (sd2 != sd) {
                if (sd2 != NULL) {
                    ...
                    log_info(LD_DIR,
                             ...
                             "router_get_by_extrainfo_digest() value. This has "
                             "ID %s "
...
routerinfo_incompatible_with_extrainfo(const crypto_pk_t *identity_pkey,
                                       extrainfo_t *ei, signed_descriptor_t *sd,
                                       const char **msg)
{
...
err:
    if (digest_matches) {
         ...
         * corresponding extrainfo.  But insanely, it doesn't match the
