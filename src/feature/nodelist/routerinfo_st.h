...
struct routerinfo_t {
    ...
    unsigned int
        policy_is_reject_star : 1; /**< True iff the exit policy for this
...
#define ROUTER_PURPOSE_UNKNOWN 255
    ...
    /** In what way did we find out about this router?  One of
     * ROUTER_PURPOSE_*. Routers of different purposes are kept segregated and
     * used for different things; see notes on ROUTER_PURPOSE_* macros above.
     */
    uint8_t purpose;
};
