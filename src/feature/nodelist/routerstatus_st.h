...
struct routerstatus_t {
    ...
    unsigned int
        is_authority : 1; /**< True iff this router is an authority. */
    ...
    unsigned int is_possible_guard : 1; /**< True iff this router would be a
                                         * good choice as an entry guard. */
    unsigned int is_bad_exit : 1; /**< True iff this node is a bad choice for
                                   * an exit node. */
    unsigned int is_hs_dir : 1; /**< True iff this router is a v2-or-later
    ...
    unsigned int
        is_v2_dir : 1; /** True iff this router publishes an open DirPort
                        ...
                        */
    unsigned int
        is_staledesc : 1; /** True iff the authorities think this router
    ...
    uint32_t bandwidth_kb; /**< Bandwidth (capacity) of the router as reported
                            * in the vote/consensus, in kilobytes/sec. */
    ...
    char
        *exitsummary; /**< exit policy summary -
