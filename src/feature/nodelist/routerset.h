...
struct routerset_t {
    /** A list of strings for the elements of the policy.  Each string is
     * either a nickname, a hexadecimal identity fingerprint, or an address
     * policy.  A router belongs to the set if its nickname OR its identity OR
     * its address matches an entry here. */
    smartlist_t *list;
    ...
    /** Total number of countries we knew about when we built
     * <b>countries</b>.*/
    int n_countries;
