                   ...
                   sr_phase_t phase)
{
    ...
    switch (phase) {
        case SR_PHASE_COMMIT:
            ...
            /* A commit with a reveal value during commitment phase is very
             * wrong. */
            if (commit_has_reveal_value(commit)) {
                log_warn(LD_DIR,
        ...
        case SR_PHASE_REVEAL:
             ...
             *
             * If all the above are true, then we are interested in this new
             * commit for its reveal information. */
