...
int add_ed25519_to_dir(const ed25519_public_key_t *edkey, struct authdir_config_t *list,
                       rtr_flags_t add_status);
...
enum was_router_added_t dirserv_add_multiple_descriptors(const char *desc, size_t desclen,
                                                         uint8_t purpose, const char *source,
                                                         const char **msg);
enum was_router_added_t dirserv_add_descriptor(routerinfo_t *ri, const char **msg,
                                               const char *source);
