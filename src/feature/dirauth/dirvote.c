                                        ...
                                        authority_cert_t *cert)
{
  ...
  v3_out->recommended_relay_protocols =
    tor_strdup("Cons=2 Desc=2 DirCache=1-2 HSDir=1 HSIntro=3 HSRend=1 "
               "Link=4 Microdesc=2 Relay=2");
  v3_out->recommended_client_protocols =
    tor_strdup("Cons=2 Desc=2 DirCache=1-2 HSDir=1 HSIntro=3 HSRend=1 "
               "Link=4 Microdesc=2 Relay=2");
  v3_out->required_client_protocols =
    tor_strdup("Cons=2 Desc=2 DirCache=1 HSDir=1 HSIntro=3 HSRend=1 "
               "Link=4 Microdesc=2 Relay=2");
  v3_out->required_relay_protocols =
    tor_strdup("Cons=2 Desc=2 DirCache=1 HSDir=1 HSIntro=3 HSRend=1 "
               "Link=3-4 Microdesc=2 Relay=1-2");
