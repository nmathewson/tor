...
consensus_cache_entry_t *consensus_cache_find_first(consensus_cache_t *cache, const char *key,
                                                    const char *value);

void consensus_cache_find_all(smartlist_t *out, consensus_cache_t *cache, const char *key,
                              const char *value);
...
int consensus_cache_entry_get_body(const consensus_cache_entry_t *ent, const uint8_t **body_out,
                                   size_t *sz_out);
