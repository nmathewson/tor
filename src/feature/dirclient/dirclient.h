...
void directory_post_to_dirservers(uint8_t dir_purpose, uint8_t router_purpose, dirinfo_type_t type,
...
void directory_get_from_all_authorities(uint8_t dir_purpose, uint8_t router_purpose,
                                        const char *resource);
...
void directory_request_set_payload(directory_request_t *req, const char *payload,
                                   size_t payload_len);
...
STATIC int allowed_anonymous_connection_compression_method(enum compress_method_t);
STATIC void warn_disallowed_anonymous_compression_method(enum compress_method_t);
