...
struct download_status_t {
    ...
    uint8_t n_download_attempts; /**< Number of (potentially concurrent)
                                  * attempts to download the most recent
                                  * object, since the last success. */
    download_schedule_bitfield_t
        schedule : 8; /**< What kind of object is being
    ...
    uint8_t
        last_backoff_position; /**< number of attempts/failures, depending
