...
char *router_dump_router_to_string(routerinfo_t *router, const crypto_pk_t *ident_key,
                                   const crypto_pk_t *tap_key,
                                   const struct curve25519_keypair_t *ntor_keypair,
                                   const struct ed25519_keypair_t *signing_keypair);
char *router_dump_exit_policy_to_string(const routerinfo_t *router, int include_ipv4,
                                        int include_ipv6);
...
void log_addr_has_changed(int severity, const tor_addr_t *prev, const tor_addr_t *cur,
                          const char *source);
...
MOCK_DECL(STATIC const struct curve25519_keypair_t *, get_current_curve25519_keypair, (void));

MOCK_DECL(STATIC int, router_build_fresh_unsigned_routerinfo, (routerinfo_t * *ri_out));
