...
void port_warn_nonlocal_ext_orports(const struct smartlist_t *ports, const char *portname);

int port_parse_ports_relay(struct or_options_t *options, char **msg, struct smartlist_t *ports_out,
                           int *have_low_ports_out);
void port_update_port_set_relay(struct or_options_t *options, const struct smartlist_t *ports);

int options_validate_relay_os(const struct or_options_t *old_options, struct or_options_t *options,
                              char **msg);
...
int options_act_relay_stats(const struct or_options_t *old_options, bool *print_notice_out);
...
STATIC int have_enough_mem_for_dircache(const struct or_options_t *options, size_t total_mem,
                                        char **msg);
...
static inline int
options_validate_relay_mode(const struct or_options_t *old_options, struct or_options_t *options,
                            char **msg)
{
    (void)old_options;
