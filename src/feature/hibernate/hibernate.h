...
typedef enum {
    ...
    /** We're trying to shut down cleanly, and we'll kill all active
     * connections at shutdown_time. */
    ...
    /** We start out in state default, which means we havent decided which
     * state we're in. */
