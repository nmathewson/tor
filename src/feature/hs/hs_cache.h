...
const hs_descriptor_t *hs_cache_lookup_as_client(const struct ed25519_public_key_t *key);
...
void hs_cache_client_intro_state_note(const struct ed25519_public_key_t *service_pk,
