...
void hs_circuitmap_register_intro_circ_v3_relay_side(
    struct or_circuit_t *circ, const ed25519_public_key_t *auth_key);
...
void
hs_circuitmap_register_intro_circ_v2_service_side(struct origin_circuit_t *circ,
                                                  const uint8_t *digest);
void hs_circuitmap_register_intro_circ_v3_service_side(
    struct origin_circuit_t *circ, const ed25519_public_key_t *auth_key);
void
