...
int hs_service_receive_intro_established(origin_circuit_t *circ, const uint8_t *payload,
                                         size_t payload_len);
int hs_service_receive_introduce2(origin_circuit_t *circ, const uint8_t *payload,
                                  size_t payload_len);
...
void hs_service_upload_desc_to_dir(const char *encoded_desc, const uint8_t version,
...
STATIC hs_service_intro_point_t *service_intro_point_find_by_ident(const hs_service_t *service,
...
STATIC void get_objects_from_ident(const hs_ident_circuit_t *ident, hs_service_t **service,
...
#    define service_authorized_client_free(c) \
        FREE_AND_NULL(hs_service_authorized_client_t, service_authorized_client_free_, (c))
...
STATIC void service_desc_schedule_upload(hs_service_descriptor_t *desc, time_t now,
