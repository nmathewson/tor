...
#define VAR_NODUMP(varname, conftype, member, initvalue) \
    CONFIG_VAR_ETYPE(or_options_t, varname, conftype, member, CFLG_NODUMP, initvalue)
#define VAR_NODUMP_IMMUTABLE(varname, conftype, member, initvalue)                          \
    CONFIG_VAR_ETYPE(or_options_t, varname, conftype, member, CFLG_NODUMP | CFLG_IMMUTABLE, \
                     initvalue)
...
#define VAR_IMMUTABLE(varname, conftype, member, initvalue) \
    CONFIG_VAR_ETYPE(or_options_t, varname, conftype, member, CFLG_IMMUTABLE, initvalue)
...
static const config_var_t option_vars_[] = {
    ...
    VAR("AccountingRule", STRING, AccountingRule_option, "max"), V(AccountingStart, STRING, NULL),
    V(Address, STRING, NULL), OBSOLETE("AllowDotExit"), OBSOLETE("AllowInvalidNodes"),
    V(AllowNonRFC953Hostnames, BOOL, "0"), OBSOLETE("AllowSingleHopCircuits"),
    OBSOLETE("AllowSingleHopExits"), V(AlternateBridgeAuthority, LINELIST, NULL),
    V(AlternateDirAuthority, LINELIST, NULL), OBSOLETE("AlternateHSAuthority"),
    V(AssumeReachable, BOOL, "0"), OBSOLETE("AuthDirBadDir"), OBSOLETE("AuthDirBadDirCCs"),
    ...
    V(AutomapHostsSuffixes, CSV, ".onion,.exit"), V(AvoidDiskWrites, BOOL, "0"),
    V(BandwidthBurst, MEMUNIT, "1 GB"), V(BandwidthRate, MEMUNIT, "1 GB"),
    V(BridgeAuthoritativeDir, BOOL, "0"), VAR("Bridge", LINELIST, Bridges, NULL),
    V(BridgePassword, STRING, NULL), V(BridgeRecordUsageByCountry, BOOL, "1"),
    V(BridgeRelay, BOOL, "0"), V(BridgeDistribution, STRING, NULL),
    VAR_IMMUTABLE("CacheDirectory", FILENAME, CacheDirectory_option, NULL),
    V(CacheDirectoryGroupReadable, AUTOBOOL, "auto"), V(CellStatistics, BOOL, "0"),
    V(PaddingStatistics, BOOL, "1"), V(LearnCircuitBuildTimeout, BOOL, "1"),
    V(CircuitBuildTimeout, INTERVAL, "0"), OBSOLETE("CircuitIdleTimeout"),
    V(CircuitsAvailableTimeout, INTERVAL, "0"), V(CircuitStreamTimeout, INTERVAL, "0"),
    ...
    V(ClientPreferIPv6ORPort, AUTOBOOL, "auto"), V(ClientPreferIPv6DirPort, AUTOBOOL, "auto"),
    OBSOLETE("ClientAutoIPv6ORPort"), V(ClientRejectInternalAddresses, BOOL, "1"),
    ...
    V(ControlPortFileGroupReadable, BOOL, "0"), V(ControlPortWriteToFile, FILENAME, NULL),
    V(ControlSocket, LINELIST, NULL), V(ControlSocketsGroupWritable, BOOL, "0"),
    V(UnixSocksGroupWritable, BOOL, "0"), V(CookieAuthentication, BOOL, "0"),
    V(CookieAuthFileGroupReadable, BOOL, "0"), V(CookieAuthFile, FILENAME, NULL),
    ...
    V(DirAuthorityFallbackRate, DOUBLE, "0.1"), V_IMMUTABLE(DisableAllSwap, BOOL, "0"),
    V_IMMUTABLE(DisableDebuggerAttachment, BOOL, "1"), OBSOLETE("DisableIOCP"),
    OBSOLETE("DisableV2DirectoryInfo_"), OBSOLETE("DynamicDHGroups"), VPORT(DNSPort),
    OBSOLETE("DNSListenAddress"), V(DormantClientTimeout, INTERVAL, "24 hours"),
    V(DormantTimeoutDisabledByIdleStreams, BOOL, "1"), V(DormantOnFirstStartup, BOOL, "0"),
    V(DormantCanceledByStartup, BOOL, "0"),
    /* DoS circuit creation options. */
    V(DoSCircuitCreationEnabled, AUTOBOOL, "auto"),
    V(DoSCircuitCreationMinConnections, POSINT, "0"), V(DoSCircuitCreationRate, POSINT, "0"),
    V(DoSCircuitCreationBurst, POSINT, "0"), V(DoSCircuitCreationDefenseType, INT, "0"),
    V(DoSCircuitCreationDefenseTimePeriod, INTERVAL, "0"),
    /* DoS connection options. */
    V(DoSConnectionEnabled, AUTOBOOL, "auto"), V(DoSConnectionMaxConcurrentCount, POSINT, "0"),
    V(DoSConnectionDefenseType, INT, "0"),
    /* DoS single hop client options. */
    V(DoSRefuseSingleHopClientRendezvous, AUTOBOOL, "auto"), V(DownloadExtraInfo, BOOL, "0"),
    V(TestingEnableConnBwEvent, BOOL, "0"), V(TestingEnableCellStatsEvent, BOOL, "0"),
    OBSOLETE("TestingEnableTbEmptyEvent"), V(EnforceDistinctSubnets, BOOL, "1"),
    V_D(EntryNodes, ROUTERSET, NULL), V(EntryStatistics, BOOL, "0"),
    OBSOLETE("TestingEstimatedDescriptorPropagationTime"), V_D(ExcludeNodes, ROUTERSET, NULL),
    V_D(ExcludeExitNodes, ROUTERSET, NULL), OBSOLETE("ExcludeSingleHopRelays"),
    ...
    V(ExitPolicyRejectPrivate, BOOL, "1"), V(ExitPolicyRejectLocalInterfaces, BOOL, "0"),
    V(ExitPortStatistics, BOOL, "0"), V(ExtendAllowPrivateAddresses, BOOL, "0"),
    V(ExitRelay, AUTOBOOL, "auto"), VPORT(ExtORPort), V(ExtORPortCookieAuthFile, FILENAME, NULL),
    V(ExtORPortCookieAuthFileGroupReadable, BOOL, "0"), V(ExtraInfoStatistics, BOOL, "1"),
    V(ExtendByEd25519ID, AUTOBOOL, "auto"), V(FallbackDir, LINELIST, NULL),

    V(UseDefaultFallbackDirs, BOOL, "1"),

    OBSOLETE("FallbackNetworkstatusFile"), V(FascistFirewall, BOOL, "0"), V(FirewallPorts, CSV, ""),
    OBSOLETE("FastFirstHopPK"), V(FetchDirInfoEarly, BOOL, "0"),
    V(FetchDirInfoExtraEarly, BOOL, "0"), V(FetchServerDescriptors, BOOL, "1"),
    V(FetchHidServDescriptors, BOOL, "1"), V(FetchUselessDescriptors, BOOL, "0"),
    OBSOLETE("FetchV2Networkstatus"), V(GeoIPExcludeUnknown, AUTOBOOL, "auto"),
#ifdef _WIN32
    ...
    V(GeoIPv6File, FILENAME, SHARE_DATADIR PATH_SEPARATOR "tor" PATH_SEPARATOR "geoip6"),
    ...
    VAR("HiddenServiceEnableIntroDoSRatePerSec", LINELIST_S, RendConfigLines, NULL),
    VAR("HiddenServiceEnableIntroDoSBurstPerSec", LINELIST_S, RendConfigLines, NULL),
    VAR("HiddenServiceOnionBalanceInstance", LINELIST_S, RendConfigLines, NULL),
    ...
    V_IMMUTABLE(HiddenServiceNonAnonymousMode, BOOL, "0"), V(HTTPProxy, STRING, NULL),
    V(HTTPProxyAuthenticator, STRING, NULL), V(HTTPSProxy, STRING, NULL),
    V(HTTPSProxyAuthenticator, STRING, NULL), VPORT(HTTPTunnelPort), V(IPv6Exit, BOOL, "0"),
    VAR("ServerTransportPlugin", LINELIST, ServerTransportPlugin, NULL),
    V(ServerTransportListenAddr, LINELIST, NULL), V(ServerTransportOptions, LINELIST, NULL),
    ...
    V(KeepalivePeriod, INTERVAL, "5 minutes"), V_IMMUTABLE(KeepBindCapabilities, AUTOBOOL, "auto"),
    VAR("Log", LINELIST, Logs, NULL), V(LogMessageDomains, BOOL, "0"),
    V(LogTimeGranularity, MSEC_INTERVAL, "1 second"), V(TruncateLogFile, BOOL, "0"),
    V_IMMUTABLE(SyslogIdentityTag, STRING, NULL), V_IMMUTABLE(AndroidIdentityTag, STRING, NULL),
    V(LongLivedPorts, CSV, "21,22,706,1863,5050,5190,5222,5223,6523,6667,6697,8300"),
    VAR("MapAddress", LINELIST, AddressMap, NULL), V(MaxAdvertisedBandwidth, MEMUNIT, "1 GB"),
    V(MaxCircuitDirtiness, INTERVAL, "10 minutes"), V(MaxClientCircuitsPending, POSINT, "32"),
    V(MaxConsensusAgeForDiffs, INTERVAL, "0 seconds"),
    VAR("MaxMemInQueues", MEMUNIT, MaxMemInQueues_raw, "0"), OBSOLETE("MaxOnionsPending"),
    V(MaxOnionQueueDelay, MSEC_INTERVAL, "1750 msec"),
    V(MaxUnparseableDescSizeToLog, MEMUNIT, "10 MB"),
    VAR("MyFamily", LINELIST, MyFamily_lines, NULL), V(NewCircuitPeriod, INTERVAL, "30 seconds"),
    OBSOLETE("NamingAuthoritativeDirectory"), OBSOLETE("NATDListenAddress"), VPORT(NATDPort),
    V(Nickname, STRING, NULL), OBSOLETE("PredictedPortsRelevanceTime"), OBSOLETE("WarnUnsafeSocks"),
    VAR("NodeFamily", LINELIST, NodeFamilies, NULL), V_IMMUTABLE(NoExec, BOOL, "0"),
    V(NumCPUs, POSINT, "0"), V(NumDirectoryGuards, POSINT, "0"), V(NumEntryGuards, POSINT, "0"),
    V(NumPrimaryGuards, POSINT, "0"), V(OfflineMasterKey, BOOL, "0"), OBSOLETE("ORListenAddress"),
    VPORT(ORPort), V(OutboundBindAddress, LINELIST, NULL), V(OutboundBindAddressOR, LINELIST, NULL),
    ...
    V(PathBiasExtremeUseRate, DOUBLE, "-1"), V(PathBiasScaleUseThreshold, INT, "-1"),

    V(PathsNeededToBuildCircuits, DOUBLE, "-1"), V(PerConnBWBurst, MEMUNIT, "0"),
    V(PerConnBWRate, MEMUNIT, "0"), V_IMMUTABLE(PidFile, FILENAME, NULL),
    V_IMMUTABLE(TestingTorNetwork, BOOL, "0"),

    V(TestingLinkCertLifetime, INTERVAL, "2 days"), V(TestingAuthKeyLifetime, INTERVAL, "2 days"),
    V(TestingLinkKeySlop, INTERVAL, "3 hours"), V(TestingAuthKeySlop, INTERVAL, "3 hours"),
    ...
    V(PublishHidServDescriptors, BOOL, "1"), V(ReachableAddresses, LINELIST, NULL),
    V(ReachableDirAddresses, LINELIST, NULL), V(ReachableORAddresses, LINELIST, NULL),
    OBSOLETE("RecommendedPackages"), V(ReducedConnectionPadding, BOOL, "0"),
    V(ConnectionPadding, AUTOBOOL, "auto"), V(RefuseUnknownExits, AUTOBOOL, "auto"),
    V(CircuitPadding, BOOL, "1"), V(ReducedCircuitPadding, BOOL, "0"),
    V(RejectPlaintextPorts, CSV, ""), V(RelayBandwidthBurst, MEMUNIT, "0"),
    V(RelayBandwidthRate, MEMUNIT, "0"), V(RendPostPeriod, INTERVAL, "1 hour"),
    V(RephistTrackTime, INTERVAL, "24 hours"), V_IMMUTABLE(RunAsDaemon, BOOL, "0"),
    V(ReducedExitPolicy, BOOL, "0"),
    OBSOLETE("RunTesting"), // currently unused
    V_IMMUTABLE(Sandbox, BOOL, "0"), V(SafeLogging, STRING, "1"), V(SafeSocks, BOOL, "0"),
    V(ServerDNSAllowBrokenConfig, BOOL, "1"), V(ServerDNSAllowNonRFC953Hostnames, BOOL, "0"),
    V(ServerDNSDetectHijacking, BOOL, "1"), V(ServerDNSRandomizeCase, BOOL, "1"),
    V(ServerDNSResolvConfFile, FILENAME, NULL), V(ServerDNSSearchDomains, BOOL, "0"),
    V(ServerDNSTestAddresses, CSV, "www.google.com,www.mit.edu,www.yahoo.com,www.slashdot.org"),
    OBSOLETE("SchedulerLowWaterMark__"), OBSOLETE("SchedulerHighWaterMark__"),
    OBSOLETE("SchedulerMaxFlushCells__"), V(KISTSchedRunInterval, MSEC_INTERVAL, "0 msec"),
    V(KISTSockBufSizeFactor, DOUBLE, "1.0"), V(Schedulers, CSV, "KIST,KISTLite,Vanilla"),
    V(ShutdownWaitLength, INTERVAL, "30 seconds"), OBSOLETE("SocksListenAddress"),
    V(SocksPolicy, LINELIST, NULL), VPORT(SocksPort), V(SocksTimeout, INTERVAL, "2 minutes"),
    V(SSLKeyLifetime, INTERVAL, "0"), OBSOLETE("StrictEntryNodes"), OBSOLETE("StrictExitNodes"),
    V(StrictNodes, BOOL, "0"), OBSOLETE("Support022HiddenServices"), V(TestSocks, BOOL, "0"),
    V_IMMUTABLE(TokenBucketRefillInterval, MSEC_INTERVAL, "100 msec"), OBSOLETE("Tor2webMode"),
    OBSOLETE("Tor2webRendezvousPoints"), OBSOLETE("TLSECGroup"), V(TrackHostExits, CSV, NULL),
    V(TrackHostExitsExpire, INTERVAL, "30 minutes"), OBSOLETE("TransListenAddress"),
    VPORT(TransPort), V(TransProxyType, STRING, "default"), OBSOLETE("TunnelDirConns"),
    V(UpdateBridgesFromAuthority, BOOL, "0"), V(UseBridges, BOOL, "0"),
    VAR("UseEntryGuards", BOOL, UseEntryGuards_option, "1"), OBSOLETE("UseEntryGuardsAsDirGuards"),
    V(UseGuardFraction, AUTOBOOL, "auto"), V(UseMicrodescriptors, AUTOBOOL, "auto"),
    OBSOLETE("UseNTorHandshake"), V_IMMUTABLE(User, STRING, NULL), OBSOLETE("UserspaceIOCPBuffers"),
    OBSOLETE("V1AuthoritativeDirectory"), OBSOLETE("V2AuthoritativeDirectory"),
    VAR("V3AuthoritativeDirectory", BOOL, V3AuthoritativeDir, "0"),
    V(TestingV3AuthInitialVotingInterval, INTERVAL, "30 minutes"),
    V(TestingV3AuthInitialVoteDelay, INTERVAL, "5 minutes"),
    V(TestingV3AuthInitialDistDelay, INTERVAL, "5 minutes"),
    V(TestingV3AuthVotingStartOffset, INTERVAL, "0"), V(V3AuthVotingInterval, INTERVAL, "1 hour"),
    V(V3AuthVoteDelay, INTERVAL, "5 minutes"), V(V3AuthDistDelay, INTERVAL, "5 minutes"),
    ...
    OBSOLETE("VoteOnHidServDirectoriesV2"), V(VirtualAddrNetworkIPv4, STRING, "127.192.0.0/10"),
    V(VirtualAddrNetworkIPv6, STRING, "[FE80::]/10"), V(WarnPlaintextPorts, CSV, "23,109,110,143"),
    OBSOLETE("UseFilteringSSLBufferevents"), OBSOLETE("__UseFilteringSSLBufferevents"),
    ...
    VAR_NODUMP_IMMUTABLE("__DisableSignalHandlers", BOOL, DisableSignalHandlers, "0"),
    VAR_NODUMP("__LeaveStreamsUnattached", BOOL, LeaveStreamsUnattached, "0"),
    VAR_NODUMP("__HashedControlSessionPassword", LINELIST, HashedControlSessionPassword, NULL),
    VAR_NODUMP("__OwningControllerProcess", STRING, OwningControllerProcess, NULL),
    VAR_NODUMP_IMMUTABLE("__OwningControllerFD", UINT64, OwningControllerFD, UINT64_MAX_STRING),
    ...
    V(ClientBootstrapConsensusAuthorityOnlyDownloadInitialDelay, CSV_INTERVAL, "0"),
    ...
    OBSOLETE("TestingDescriptorMaxDownloadTries"), OBSOLETE("TestingMicrodescMaxDownloadTries"),
    OBSOLETE("TestingCertMaxDownloadTries"),
    VAR_INVIS("___UsingTestNetworkDefaults", BOOL, UsingTestNetworkDefaults_, "0"),
...
set_options(or_options_t *new_val, char **msg)
{
    ...
    if (subsystems_set_options(get_options_mgr(), new_val) < 0 ||
        ...
        if (!tor_event_loop_shutdown_is_pending()) {
            log_err(LD_BUG, "Acting on config options left us in a broken state. Dying.");
    ...
    if (old_options && old_options != global_options) {
        config_line_t *changes = config_get_changes(get_options_mgr(), old_options, new_val);
...
options_clear_cb(const config_mgr_t *mgr, void *opts)
{
    ...
    if (options->NodeFamilySets) {
        SMARTLIST_FOREACH(options->NodeFamilySets, routerset_t *, rs, routerset_free(rs));
...
add_default_trusted_dir_authorities(dirinfo_type_t type)
{
    ...
    for (i = 0; default_authorities[i]; i++) {
        if (parse_dir_authority_line(default_authorities[i], type, 0) < 0) {
            log_err(LD_BUG, "Couldn't parse internal DirAuthority line %s", default_authorities[i]);
        }
    }
}
...
add_default_fallback_dir_servers, (void))
{
    ...
    for (i = 0; default_fallbacks[i]; i++) {
        if (parse_dir_fallback_line(default_fallbacks[i], 0) < 0) {
            log_err(LD_BUG, "Couldn't parse internal FallbackDir line %s", default_fallbacks[i]);
        }
    }
}
 ...
 */
static int
validate_dir_servers(const or_options_t *options, const or_options_t *old_options)
{
    config_line_t *cl;

    if (options->DirAuthorities &&
        (options->AlternateDirAuthority || options->AlternateBridgeAuthority)) {
        log_warn(LD_CONFIG, "You cannot set both DirAuthority and Alternate*Authority.");
        return -1;
    }
    ...
    if ((options->DirAuthorities &&
        ...
        (options->AlternateDirAuthority &&
         (!old_options ||
          !config_lines_eq(options->AlternateDirAuthority, old_options->AlternateDirAuthority)))) {
        log_warn(LD_CONFIG, "You have used DirAuthority or AlternateDirAuthority to "
 ...
 */
int
consider_adding_dir_servers(const or_options_t *options, const or_options_t *old_options)
{
    config_line_t *cl;
    int need_to_update =
 ...
 */
static int
check_and_create_data_directory(int create, const char *directory, int group_readable,
                                const char *owner, char **msg_out)
{
    ...
    if (group_readable) {
        ...
        if (chmod(directory, 0750)) {
            log_warn(LD_FS, "Unable to make %s group-readable: %s", directory, strerror(errno));
        }
    }
#endif /* !defined(_WIN32) */
...
create_keys_directory(const or_options_t *options)
{
    ...
    if (check_private_dir(options->DataDirectory, cpd_opts, options->User)) {
        log_err(LD_OR, "Can't create/check datadirectory %s", options->DataDirectory);
        return -1;
    }
 ...
 **/
static int
compute_group_readable_flag(const char *datadir, const char *subdir, int datadir_gr, int subdir_gr)
{
    if (subdir_gr != -1) {
...
options_create_directories(char **msg_out)
{
    ...
    if (check_and_create_data_directory(running_tor /* create */, options->DataDirectory,
                                        options->DataDirectoryGroupReadable, options->User,
                                        msg_out) < 0) {
        return -1;
    }
    ...
    const int key_dir_group_readable = compute_group_readable_flag(
        options->DataDirectory, options->KeyDirectory, options->DataDirectoryGroupReadable,
        options->KeyDirectoryGroupReadable);

    if (check_and_create_data_directory(running_tor /* create */, options->KeyDirectory,
                                        key_dir_group_readable, options->User, msg_out) < 0) {
        return -1;
    }

    const int cache_dir_group_readable = compute_group_readable_flag(
        options->DataDirectory, options->CacheDirectory, options->DataDirectoryGroupReadable,
        options->CacheDirectoryGroupReadable);

    if (check_and_create_data_directory(running_tor /* create */, options->CacheDirectory,
...
options_start_listener_transaction(const or_options_t *old_options, char **msg_out)
{
    ...
    if (!sandbox_is_active()) {
        if (set_max_file_descriptors((unsigned)options->ConnLimit, &options->ConnLimit_) < 0) {
...
options_commit_listener_transaction(listener_transaction_t *xn)
{
    ...
    if (xn->set_conn_limit) {
        ...
        log_info(LD_GENERAL,
                 ...
                 options->ConnLimit, options->ConnLimit_, options->ConnLimit_high_thresh,
...
options_start_log_transaction(const or_options_t *old_options, char **msg_out)
{
    ...
    xn->safelogging_changed = !old_options || old_options->SafeLogging_ != options->SafeLogging_;
 ...
 */
static int
options_transition_affects_guards(const or_options_t *old_options, const or_options_t *new_options)
{
...
options_act, (const or_options_t *old_options))
{
    ...
    /* disable ptrace and later, other basic debugging techniques */
    {
        ...
        if (options->DisableDebuggerAttachment && !disabled_debugger_attach && running_tor) {
        ...
        } else if (!options->DisableDebuggerAttachment && !warned_debugger_attach) {
    ...
    if (options->Bridges) {
        ...
        for (cl = options->Bridges; cl; cl = cl->next) {
            ...
            if (!bridge_line) {
                // LCOV_EXCL_START
                log_warn(LD_BUG, "Previously validated Bridge line could not be added!");
                return -1;
                // LCOV_EXCL_STOP
            }
    ...
    if (running_tor && hs_config_service_all(options, 0) < 0) {
        // LCOV_EXCL_START
        log_warn(LD_BUG, "Previously validated hidden services line could not be added!");
        return -1;
        // LCOV_EXCL_STOP
    }
    ...
    if (running_tor && !old_options && options->OwningControllerFD != UINT64_MAX) {
        const unsigned ctrl_flags = CC_LOCAL_FD_IS_OWNER | CC_LOCAL_FD_IS_AUTHENTICATED;
    ...
    if (options->PidFile && !sandbox_is_active()) {
        if (write_pidfile(options->PidFile) < 0) {
            log_err(LD_CONFIG, "Unable to write PIDFile %s", escaped(options->PidFile));
            return -1;
        }
    }
    ...
    if (old_options) {
        ...
        if ((options->UseEntryGuards && !old_options->UseEntryGuards) ||
            ...
            (options->UseBridges && !config_lines_eq(options->Bridges, old_options->Bridges)) ||
            !routerset_equal(old_options->ExcludeNodes, options->ExcludeNodes) ||
            !routerset_equal(old_options->ExcludeExitNodes, options->ExcludeExitNodes) ||
        ...
        if (!smartlist_strings_eq(old_options->TrackHostExits, options->TrackHostExits))
            revise_trackexithosts = 1;
    ...
    options->DirReqStatistics = options->DirReqStatistics_option && server_mode(options);
...
static const struct {
    ...
    {.name = "--library-versions", .command = CMD_IMMEDIATE, .quiet = QUIET_HUSH},
    {.name = "-h", .command = CMD_IMMEDIATE, .quiet = QUIET_HUSH},
    {.name = "--help", .command = CMD_IMMEDIATE, .quiet = QUIET_HUSH},
    {.name = "--list-torrc-options", .command = CMD_IMMEDIATE, .quiet = QUIET_HUSH},
    {.name = "--list-deprecated-options", .command = CMD_IMMEDIATE},
    {.name = "--nt-service"},
    {.name = "-nt-service"},
    {.name = "--dbg-dump-subsystem-list", .command = CMD_IMMEDIATE, .quiet = QUIET_HUSH},
    {.name = NULL},
};
    ...
    while (i < argc) {
        ...
        if (want_arg == ARGUMENT_NECESSARY && is_last) {
            if (ignore_errors) {
                ...
                log_warn(LD_CONFIG, "Command-line option '%s' with no value. Failing.", argv[i]);
        ...
        param->next = NULL;
        log_debug(LD_CONFIG, "command line: parsed keyword '%s', value '%s'", param->key,
                  param->value);
...
options_trial_assign(config_line_t *list, unsigned flags, char **msg)
{
    ...
    if ((r = config_assign(get_options_mgr(), trial_options, list, flags, msg)) < 0) {
...
options_init(or_options_t *options)
{
    ...
    char *msg = NULL;
    if (config_assign(get_options_mgr(), options, dflts, CAL_WARN_DEPRECATIONS, &msg) < 0) {
 ...
 */
static setopt_err_t
options_validate_and_set(const or_options_t *old_options, or_options_t *new_options, char **msg_out)
{
    setopt_err_t rv;
 ...
 */
int
options_validate(const or_options_t *old_options, or_options_t *options, char **msg)
{
    validation_status_t vs;
...
warn_about_relative_paths(const or_options_t *options)
{
    ...
    for (config_line_t *hs_line = options->RendConfigLines; hs_line; hs_line = hs_line->next) {
...
options_validate_single_onion(or_options_t *options, char **msg)
{
    ...
    if (options->HiddenServiceSingleHopMode && !options->HiddenServiceNonAnonymousMode) {
    ...
    if (options->HiddenServiceNonAnonymousMode && !options->HiddenServiceSingleHopMode) {
    ...
    const int client_port_set =
        (options->SocksPort_set || options->TransPort_set || options->NATDPort_set ||
         options->DNSPort_set || options->HTTPTunnelPort_set);
    ...
    if (rend_service_allow_non_anonymous_connection(options) && options->UseEntryGuards) {
...
options_validate_cb(const void *old_options_, void *options_, char **msg)
{
    ...
    *msg = NULL;
    ...
    if (parse_ports(options, 1, msg, &n_ports, &world_writable_control_socket) < 0)
        return -1;
    ...
    if (n_ports == 0 && !options->RendConfigLines)
        log_warn(LD_CONFIG, "SocksPort, TransPort, NATDPort, DNSPort, and ORPort are all "
...
#    endif /* !defined(KERNEL_MAY_SUPPORT_IPFW) */
        ...
        if (strcasecmp(options->TransProxyType, "default") && !options->TransPort_set) {
    ...
    if (options->TokenBucketRefillInterval <= 0 || options->TokenBucketRefillInterval > 1000) {
    ...
    if (options->MaxClientCircuitsPending <= 0 ||
        ...
        tor_asprintf(msg,
                     ...
                     "was set to %d",
                     MAX_MAX_CLIENT_CIRCUITS_PENDING, options->MaxClientCircuitsPending);
        return -1;
    }
    ...
    if (validate_ports_csv(options->RejectPlaintextPorts, "RejectPlaintextPorts", msg) < 0)
        return -1;

    if (validate_ports_csv(options->WarnPlaintextPorts, "WarnPlaintextPorts", msg) < 0)
        return -1;
    ...
    options->MaxMemInQueues =
        compute_real_max_mem_in_queues(options->MaxMemInQueues_raw, server_mode(options));
    ...
    if (!options->SafeLogging || !strcasecmp(options->SafeLogging, "0")) {
        ...
        tor_asprintf(msg, "Unrecognized value '%s' in SafeLogging", escaped(options->SafeLogging));
        return -1;
    }
    ...
    const int min_rendpostperiod =
        options->TestingTorNetwork ? MIN_REND_POST_PERIOD_TESTING : MIN_REND_POST_PERIOD;
    ...
    if (!(options->UseEntryGuards) && (options->RendConfigLines != NULL) &&
        ...
        log_warn(LD_CONFIG, "UseEntryGuards is disabled, but you have configured one or more "
    ...
    if (options->EntryNodes && routerset_is_list(options->EntryNodes) &&
        (routerset_len(options->EntryNodes) == 1) && (options->RendConfigLines != NULL)) {
        tor_asprintf(msg, "You have one single EntryNodes and at least one hidden service "
    ...
    if (options->EntryNodes && routerset_is_list(options->EntryNodes) &&
        ...
        log_warn(LD_CONFIG, "EntryNodes is set with multiple entries and at least one "
    ...
    if (rend_service_non_anonymous_mode_enabled(options)) {
        log_warn(LD_CONFIG, "HiddenServiceNonAnonymousMode is set. Every hidden service on "
    ...
    if (!options->LearnCircuitBuildTimeout && options->CircuitBuildTimeout &&
        ...
        log_warn(LD_CONFIG,
                 ...
                 options->CircuitBuildTimeout, RECOMMENDED_MIN_CIRCUIT_BUILD_TIMEOUT);
    } else if (!options->LearnCircuitBuildTimeout && !options->CircuitBuildTimeout) {
    ...
    if (options->HeartbeatPeriod && options->HeartbeatPeriod < MIN_HEARTBEAT_PERIOD &&
    ...
    if (config_ensure_bandwidth_cap(&options->BandwidthRate, "BandwidthRate", msg) < 0)
        return -1;
    if (config_ensure_bandwidth_cap(&options->BandwidthBurst, "BandwidthBurst", msg) < 0)
        return -1;
    ...
    if (options->HashedControlSessionPassword) {
        smartlist_t *sl = decode_hashed_passwords(options->HashedControlSessionPassword);
        if (!sl) {
    ...
    if (options->OwningControllerProcess) {
        ...
        if (tor_validate_process_specifier(options->OwningControllerProcess, &validate_pspec_msg)) {
    ...
    if ((options->ControlPort_set || world_writable_control_socket) &&
        !options->HashedControlPassword && !options->HashedControlSessionPassword &&
    ...
    if (parse_virtual_addr_network(options->VirtualAddrNetworkIPv4, AF_INET, 1, msg) < 0)
        return -1;
    if (parse_virtual_addr_network(options->VirtualAddrNetworkIPv6, AF_INET6, 1, msg) < 0)
        return -1;
...
#    define RAM_IS_VERY_LARGE(x) (0)
        ...
        if (log_guess && !notice_sent) {
            log_notice(LD_CONFIG,
                       ...
                       ram ? "Based on detected system memory, " : "", (result / ONE_MEGABYTE));
            notice_sent = 1;
        }
        return result;
...
#define BAD_CHANGE_TO(opt, how)                                                             \
    do {                                                                                    \
        *msg = tor_strdup("While Tor is running" how ", changing " #opt " is not allowed"); \
        return -1;                                                                          \
    } while (0)
...
get_default_conf_file(int defaults_file)
{
    ...
    if (defaults_file) {
        ...
        tor_snprintf(defaults_path, MAX_PATH, "%s\\torrc-defaults", get_windows_conf_root());
 ...
 */
static char *
find_torrc_filename(const config_line_t *cmd_arg, int defaults_file, int *using_default_fname,
                    int *ignore_missing_torrc)
{
    ...
    for (p_index = cmd_arg; p_index; p_index = p_index->next) {
        if (!strcmp(p_index->key, fname_opt)) {
            if (fname) {
                log_warn(LD_CONFIG, "Duplicate %s options on command line.", fname_opt);
                tor_free(fname);
            }
...
options_init_from_torrc(int argc, char **argv)
{
    ...
    if (command == CMD_HASH_PASSWORD) {
        ...
        const int read_torrc_from_stdin = (f_line != NULL && strcmp(f_line->value, "-") == 0);
    ...
    {
        const config_line_t *fd_line = config_line_find(cmdline_only_options, "--passphrase-fd");
        if (fd_line) {
    ...
    {
        const config_line_t *key_line = config_line_find(cmdline_only_options, "--master-key");
        if (key_line) {
            if (command != CMD_KEYGEN) {
                         ...
                         const char *command_arg, char **msg)
{
    ...
    for (int i = 0; i < 2; ++i) {
        ...
        retval = config_get_lines_include(body, &cl, 1, body == cf ? &cf_has_include : NULL,
                                          opened_files);
        if (retval < 0) {
            err = SETOPT_ERR_PARSE;
            goto err;
        }
        retval = config_assign(get_options_mgr(), newoptions, cl, CAL_WARN_DEPRECATIONS, msg);
    ...
    /* Go through command-line variables too */
    {
        ...
        retval =
            config_assign(get_options_mgr(), newoptions, other_opts, CAL_WARN_DEPRECATIONS, msg);
    }
    if (retval < 0) {
        err = SETOPT_ERR_PARSE;
        goto err;
...
err:
    ...
    if (retry)
        return options_init_from_string(cf_defaults, cf, command, command_arg, msg);
    return err;
}
...
config_register_addressmaps(const or_options_t *options)
{
    ...
    for (opt = options->AddressMap; opt; opt = opt->next) {
        smartlist_split_string(elts, opt->value, NULL, SPLIT_SKIP_SPACE | SPLIT_IGNORE_BLANK, 2);
        if (smartlist_len(elts) < 2) {
            log_warn(LD_CONFIG, "MapAddress '%s' has too few arguments. Ignoring.", opt->value);
            goto cleanup;
        }
        ...
        if (addressmap_register_auto(from, to, 0, ADDRMAPSRC_TORRC, &msg) < 0) {
            log_warn(LD_CONFIG, "MapAddress '%s' failed: %s. Ignoring.", opt->value, msg);
            goto cleanup;
        }
...
addressmap_register_auto(const char *from, const char *to, time_t expires,
                         addressmap_entry_source_t addrmap_source, const char **msg)
{
    ...
    *msg = "whoops, forgot the error message";
    ...
    addressmap_register(from, tor_strdup(to), expires, addrmap_source, from_wildcard, to_wildcard);
 ...
 */
STATIC int
open_and_add_file_log(const log_severity_list_t *severity, const char *filename, int truncate_log)
{
...
options_init_log_granularity(const or_options_t *options, int validate_only)
{
    if (options->LogTimeGranularity <= 0) {
        ...
        return -1;
    } else if (1000 % options->LogTimeGranularity != 0 && options->LogTimeGranularity % 1000 != 0) {
 ...
 */
STATIC int
options_init_logs(const or_options_t *old_options, const or_options_t *options, int validate_only)
{
    config_line_t *opt;
    int ok;
    smartlist_t *elts;
    ...
    for (opt = options->Logs; opt; opt = opt->next) {
        ...
        if (parse_log_severity_config(&cfg, severity) < 0) {
            log_warn(LD_CONFIG, "Couldn't parse log levels in Log option 'Log %s'", opt->value);
            ok = 0;
            goto cleanup;
        }

        smartlist_split_string(elts, cfg, NULL, SPLIT_SKIP_SPACE | SPLIT_IGNORE_BLANK, 2);

        if (smartlist_len(elts) == 0)
            smartlist_add_strdup(elts, "stdout");

        if (smartlist_len(elts) == 1 && (!strcasecmp(smartlist_get(elts, 0), "stdout") ||
                                         !strcasecmp(smartlist_get(elts, 0), "stderr"))) {
            int err = smartlist_len(elts) && !strcasecmp(smartlist_get(elts, 0), "stderr");
            if (!validate_only) {
                if (run_as_daemon) {
                    log_warn(LD_CONFIG, "Can't log to %s with RunAsDaemon set; skipping stdout",
                             err ? "stderr" : "stdout");
                } else {
        ...
        if (smartlist_len(elts) == 2 && !strcasecmp(smartlist_get(elts, 0), "file")) {
            if (!validate_only) {
                ...
                if (open_and_add_file_log(severity, fname, truncate_log) < 0) {
                    log_warn(LD_CONFIG, "Couldn't open file for 'Log %s': %s", opt->value,
                             strerror(errno));
                    ok = 0;
                }
                tor_free(fname);
...
parse_bridge_line(const char *line)
{
    ...
    if (tor_addr_port_parse(LOG_INFO, addrport, &bridge_line->addr, &bridge_line->port, 443) < 0) {
    ...
    if (fingerprint) {
        ...
        if (base16_decode(bridge_line->digest, DIGEST_LEN, fingerprint, HEX_DIGEST_LEN) !=
            DIGEST_LEN) {
...
parse_tcp_proxy_line(const char *line, or_options_t *options, char **msg)
{
    ...
    smartlist_split_string(sl, line, " ", SPLIT_SKIP_SPACE | SPLIT_IGNORE_BLANK, 2);
    ...
    if (tor_addr_port_lookup(addrport_string, &options->TCPProxyAddr, &options->TCPProxyPort) < 0) {
 ...
 */
int
pt_parse_transport_line(const or_options_t *options, const char *line, int validate_only,
                        int server)
{
    smartlist_t *items = NULL;
    int r;
    ...
    smartlist_split_string(transport_list, transports, ",", SPLIT_SKIP_SPACE | SPLIT_IGNORE_BLANK,
                           0);
    SMARTLIST_FOREACH_BEGIN (transport_list, const char *, transport_name) {
        /* validate transport names */
        if (!string_is_C_identifier(transport_name)) {
            log_warn(LD_CONFIG, "Transport name is not a C identifier (%s).", transport_name);
            goto err;
        }
    ...
    if (!strcmp(type, "exec")) {
        ...
        log_warn(LD_CONFIG, "Strange %sTransportPlugin type '%s'", server ? "Server" : "Client",
                 type);
        goto err;
    }
    ...
    if (is_managed) {
        ...
        if (!server && (options->Socks4Proxy || options->Socks5Proxy || options->HTTPSProxy ||
                        options->TCPProxy)) {
        ...
        if (!validate_only) {
            log_info(LD_DIR, "%s '%s' at %s.", server ? "Server transport" : "Transport",
                     transports, fmt_addrport(&addr, port));

            if (!server) {
                transport_add_from_config(&addr, port, smartlist_get(transport_list, 0), socks_ver);
            }
        }
    }
...
STATIC int
parse_dir_authority_line(const char *line, dirinfo_type_t required_type, int validate_only)
{
    smartlist_t *items = NULL;
    int r;
    ...
    while (smartlist_len(items)) {
        ...
        if (!strcasecmp(flag, "hs") || !strcasecmp(flag, "no-hs")) {
            ...
            if (!ok)
                log_warn(LD_CONFIG, "Invalid orport '%s' on DirAuthority line.", portstring);
            ...
            if (strlen(idstr) != HEX_DIGEST_LEN ||
                base16_decode(v3_digest, DIGEST_LEN, idstr, HEX_DIGEST_LEN) != DIGEST_LEN) {
            ...
            if (ipv6_addrport_ptr) {
                ...
                if (tor_addr_port_parse(LOG_WARN, flag + strlen("ipv6="), &ipv6_addrport.addr,
                                        &ipv6_addrport.port, -1) < 0 ||
    ...
    fingerprint = smartlist_join_strings(items, "", 0, NULL);
    if (strlen(fingerprint) != HEX_DIGEST_LEN) {
        log_warn(LD_CONFIG, "Key digest '%s' for DirAuthority is wrong length %d.", fingerprint,
                 (int)strlen(fingerprint));
        goto err;
    }
    if (base16_decode(digest, DIGEST_LEN, fingerprint, HEX_DIGEST_LEN) != DIGEST_LEN) {
    ...
    if (!validate_only && (!required_type || required_type & type)) {
        ...
        if (required_type)
            type &= required_type; /* pare down what we think of them as an
                                    * authority for. */
        log_debug(LD_DIR, "Trusted %d dirserver at %s:%d (%s)", (int)type, address, (int)dir_port,
                  (char *)smartlist_get(items, 0));
        if (!(ds = trusted_dir_server_new(nickname, address, dir_port, or_port, ipv6_addrport_ptr,
...
parse_dir_fallback_line(const char *line, int validate_only)
{
    ...
    SMARTLIST_FOREACH_BEGIN (items, const char *, cp) {
        ...
        if (!strcmpstart(cp, "orport=")) {
            orport = (int)tor_parse_long(cp + strlen("orport="), 10, 1, 65535, &ok, NULL);
        } else if (!strcmpstart(cp, "id=")) {
            ok = base16_decode(id, DIGEST_LEN, cp + strlen("id="), strlen(cp) - strlen("id=")) ==
                 DIGEST_LEN;
        } else if (!strcasecmpstart(cp, "ipv6=")) {
            if (ipv6_addrport_ptr) {
                log_warn(LD_CONFIG, "Redundant ipv6 addr/port on FallbackDir line");
            } else {
                if (tor_addr_port_parse(LOG_WARN, cp + strlen("ipv6="), &ipv6_addrport.addr,
                                        &ipv6_addrport.port, -1) < 0 ||
                    tor_addr_family(&ipv6_addrport.addr) != AF_INET6) {
                    log_warn(LD_CONFIG, "Bad ipv6 addr/port %s on FallbackDir line", escaped(cp));
                    goto end;
                }
                ipv6_addrport_ptr = &ipv6_addrport;
            }
    ...
    if (tor_addr_port_split(LOG_INFO, smartlist_get(positional, 0), &address, &dirport) < 0 ||
    ...
    if (!validate_only) {
        dir_server_t *ds;
        ds = fallback_dir_server_new(&addr, dirport, orport, ipv6_addrport_ptr, id, weight);
        if (!ds) {
...
static void
warn_nonlocal_client_ports(const smartlist_t *ports, const char *portname, const int listener_type)
{
 ...
 */
int
port_cfg_line_extract_addrport(const char *line, char **addrport_out, int *is_unix_out,
                               const char **rest_out)
{
    tor_assert(line);
...
warn_client_dns_cache(const char *option, int disabling)
{
    ...
    warn_deprecated_option(option, "Client-side DNS cacheing enables a wide variety of route-"
 ...
 */
int
port_parse_config(smartlist_t *out, const config_line_t *ports, const char *portname,
                  int listener_type, const char *defaultaddr, int defaultport, const unsigned flags)
{
    smartlist_t *elts;
    int retval = -1;
    ...
    const unsigned default_to_group_writable = flags & CL_PORT_DFLT_GROUP_WRITABLE;
    ...
    for (; ports; ports = ports->next) {
        ...
        int port, ok, has_used_unix_socket_only_option = 0, is_unix_tagged_addr = 0;
        uint16_t ptmp = 0;
        const char *rest_of_line = NULL;

        if (port_cfg_line_extract_addrport(ports->value, &addrport, &is_unix_tagged_addr,
                                           &rest_of_line) < 0) {
            log_warn(LD_CONFIG, "Invalid %sPort line with unparsable address", portname);
            goto err;
        }
        ...
        /* Split the remainder... */
        smartlist_split_string(elts, rest_of_line, NULL, SPLIT_SKIP_SPACE | SPLIT_IGNORE_BLANK, 0);
        ...
        if (unix_socket_path && !conn_listener_type_supports_af_unix(listener_type)) {
        ...
        if (unix_socket_path) {
            ...
            if (tor_addr_port_lookup(addrtmp, &addr, &ptmp) < 0 || ptmp) {
                log_warn(LD_CONFIG, "Invalid address '%s' for %sPort", escaped(addrport), portname);
                tor_free(addrtmp);
                goto err;
            }
            tor_free(addrtmp);
            ...
            if (ok) {
                ...
                log_warn(LD_CONFIG, "Couldn't parse address %s for %sPort", escaped(addrport),
                         portname);
                goto err;
            }
        }
        ...
        /* not implemented yet. */
          ...
          all_addrs = 1;
                    ...
                    log_warn(LD_CONFIG, "Unrecognized %sPort option '%s'", portname, escaped(elt));
                }
            ...
            if (cfg->server_cfg.bind_ipv4_only && cfg->server_cfg.bind_ipv6_only) {
                log_warn(LD_CONFIG,
            ...
            if (cfg->server_cfg.bind_ipv4_only && tor_addr_family(&addr) != AF_INET) {
                log_warn(LD_CONFIG, "Could not interpret %sPort address as IPv4", portname);
                goto err;
            }
            if (cfg->server_cfg.bind_ipv6_only && tor_addr_family(&addr) != AF_INET6) {
                log_warn(LD_CONFIG, "Could not interpret %sPort address as IPv6", portname);
                goto err;
            }
        } else {
            ...
            SMARTLIST_FOREACH_BEGIN (elts, char *, elt) {
                ...
                if (!strcasecmpstart(elt, "SessionGroup=")) {
                    int group = (int)tor_parse_long(elt + strlen("SessionGroup="), 10, 0, INT_MAX,
                                                    &ok, NULL);
                    if (!ok || allow_no_stream_options) {
                        log_warn(LD_CONFIG, "Invalid %sPort option '%s'", portname, escaped(elt));
                        goto err;
                    }
                    if (cfg->entry_cfg.session_group >= 0) {
                        log_warn(LD_CONFIG, "Multiple SessionGroup options on %sPort", portname);
                        goto err;
                    }
        ...
        if (cfg->entry_cfg.dns_request == 0 && listener_type == CONN_TYPE_AP_DNS_LISTENER) {
            log_warn(LD_CONFIG,
        ...
        if (cfg->entry_cfg.ipv4_traffic == 0 && cfg->entry_cfg.ipv6_traffic == 0 &&
            cfg->entry_cfg.onion_traffic == 0 && listener_type != CONN_TYPE_AP_DNS_LISTENER) {
            log_warn(LD_CONFIG,
        ...
        if (cfg->entry_cfg.dns_request == 1 && cfg->entry_cfg.ipv4_traffic == 0 &&
            cfg->entry_cfg.ipv6_traffic == 0 && listener_type != CONN_TYPE_AP_DNS_LISTENER) {
            log_warn(LD_CONFIG,
        ...
        if (unix_socket_path && (cfg->entry_cfg.isolation_flags & ISO_CLIENTADDR)) {
...
int
port_count_real_listeners(const smartlist_t *ports, int listenertype, int count_sockets)
{
    int n = 0;
    SMARTLIST_FOREACH_BEGIN (ports, port_cfg_t *, port) {
 ...
 **/
STATIC int
parse_ports(or_options_t *options, int validate_only, char **msg, int *n_ports_out,
            int *world_writable_control_socket)
{
    ...
    *n_ports_out = 0;
    ...
    const unsigned gw_flag = options->UnixSocksGroupWritable ? CL_PORT_DFLT_GROUP_WRITABLE : 0;
    if (port_parse_config(
            ports, options->SocksPort_lines, "Socks", CONN_TYPE_AP_LISTENER, "127.0.0.1", 9050,
            ((validate_only ? 0 : CL_PORT_WARN_NONLOCAL) | CL_PORT_TAKES_HOSTNAMES | gw_flag)) <
        0) {
        *msg = tor_strdup("Invalid SocksPort configuration");
        goto err;
    }
    if (port_parse_config(ports, options->DNSPort_lines, "DNS", CONN_TYPE_AP_DNS_LISTENER,
                          "127.0.0.1", 0, CL_PORT_WARN_NONLOCAL | CL_PORT_TAKES_HOSTNAMES) < 0) {
        *msg = tor_strdup("Invalid DNSPort configuration");
        goto err;
    }
    if (port_parse_config(ports, options->TransPort_lines, "Trans", CONN_TYPE_AP_TRANS_LISTENER,
                          "127.0.0.1", 0, CL_PORT_WARN_NONLOCAL) < 0) {
        *msg = tor_strdup("Invalid TransPort configuration");
        goto err;
    }
    if (port_parse_config(ports, options->NATDPort_lines, "NATD", CONN_TYPE_AP_NATD_LISTENER,
                          "127.0.0.1", 0, CL_PORT_WARN_NONLOCAL) < 0) {
    ...
    if (port_parse_config(ports, options->HTTPTunnelPort_lines, "HTTP Tunnel",
                          ...
                          ((validate_only ? 0 : CL_PORT_WARN_NONLOCAL) | CL_PORT_TAKES_HOSTNAMES |
                           gw_flag)) < 0) {
        *msg = tor_strdup("Invalid HTTPTunnelPort configuration");
        goto err;
    }
    {
        unsigned control_port_flags = CL_PORT_NO_STREAM_OPTIONS | CL_PORT_WARN_NONLOCAL;
        const int any_passwords =
            (options->HashedControlPassword || options->HashedControlSessionPassword ||
             options->CookieAuthentication);
        if (!any_passwords)
        ...
        if (port_parse_config(ports, options->ControlPort_lines, "Control",
                              CONN_TYPE_CONTROL_LISTENER, "127.0.0.1", 0, control_port_flags) < 0) {
    ...
    *n_ports_out = smartlist_len(ports);
    ...
    options->SocksPort_set = !!port_count_real_listeners(ports, CONN_TYPE_AP_LISTENER, 1);
    options->TransPort_set = !!port_count_real_listeners(ports, CONN_TYPE_AP_TRANS_LISTENER, 1);
    options->NATDPort_set = !!port_count_real_listeners(ports, CONN_TYPE_AP_NATD_LISTENER, 1);
    ...
    options->ControlPort_set = !!port_count_real_listeners(ports, CONN_TYPE_CONTROL_LISTENER, 0);
    options->DNSPort_set = !!port_count_real_listeners(ports, CONN_TYPE_AP_DNS_LISTENER, 1);

    if (world_writable_control_socket) {
        SMARTLIST_FOREACH(
            ports, port_cfg_t *, p,
            if (p->type == CONN_TYPE_CONTROL_LISTENER && p->is_unix_addr && p->is_world_writable) {
...
port_binds_ipv4(const port_cfg_t *port)
{
    return tor_addr_family(&port->addr) == AF_INET ||
           (tor_addr_family(&port->addr) == AF_UNSPEC && !port->server_cfg.bind_ipv6_only);
}
...
port_binds_ipv6(const port_cfg_t *port)
{
    return tor_addr_family(&port->addr) == AF_INET6 ||
           (tor_addr_family(&port->addr) == AF_UNSPEC && !port->server_cfg.bind_ipv4_only);
}
...
get_first_listener_addrport_string(int listener_type)
{
    ...
    SMARTLIST_FOREACH_BEGIN (configured_ports, const port_cfg_t *, cfg) {
        ...
        if (cfg->type == listener_type && tor_addr_family(&cfg->addr) != AF_UNSPEC) {
...
int
port_exists_by_type_addr_port(int listener_type, const tor_addr_t *addr, int port,
                              int check_wildcard)
{
    ...
    SMARTLIST_FOREACH_BEGIN (configured_ports, const port_cfg_t *, cfg) {
        if (cfg->type == listener_type) {
            if (cfg->port == port || (check_wildcard && port == -1)) {
                ...
                const int addr_v4 =
                    tor_addr_family(addr) == AF_INET || tor_addr_family(addr) == AF_UNSPEC;
                ...
                const int addr_v6 =
                    tor_addr_family(addr) == AF_INET6 || tor_addr_family(addr) == AF_UNSPEC;
 ...
 * instead. */
int
port_exists_by_type_addr32h_port(int listener_type, uint32_t addr_ipv4h, int port,
                                 int check_wildcard)
{
    tor_addr_t ipv4;
    tor_addr_from_ipv4h(&ipv4, addr_ipv4h);
    return port_exists_by_type_addr_port(listener_type, &ipv4, port, check_wildcard);
}
...
validate_data_directories(or_options_t *options)
{
    ...
    if (options->KeyDirectory_option) {
        ...
        tor_asprintf(&options->KeyDirectory, "%s" PATH_SEPARATOR "keys", options->DataDirectory);
    }

    tor_free(options->CacheDirectory);
    if (options->CacheDirectory_option) {
        options->CacheDirectory = get_data_directory(options->CacheDirectory_option);
...
write_configuration_file(const char *fname, const or_options_t *options)
{
    ...
    tor_asprintf(&new_val, "%s\n%s\n\n%s", GENERATED_FILE_PREFIX, GENERATED_FILE_COMMENT, new_conf);
    ...
    if (rename_old) {
        ...
        if (tor_rename(fname, fn_tmp) < 0) { // XXXX sandbox doesn't allow
            log_warn(LD_FS, "Couldn't rename configuration file \"%s\" to \"%s\": %s", fname,
                     fn_tmp, strerror(errno));
            tor_free(fn_tmp);
            goto err;
        }
        tor_free(fn_tmp);
...
options_get_dir_fname2_suffix,
          (const or_options_t *options, directory_root_t roottype, const char *sub1,
           const char *sub2, const char *suffix))
{
    tor_assert(options);
    ...
    if (sub1 == NULL) {
        ...
        tor_asprintf(&fname, "%s" PATH_SEPARATOR "%s" PATH_SEPARATOR "%s%s", rootdir, sub1, sub2,
                     suffix);
    }
...
int
write_to_data_subdir(const char *subdir, const char *fname, const char *str, const char *descr)
{
 ...
 * types. */
int
getinfo_helper_config(control_connection_t *conn, const char *question, char **answer,
                      const char **errmsg)
{
    (void)conn;
    (void)errmsg;
    if (!strcmp(question, "config/names")) {
        ...
        *answer = smartlist_join_strings(sl, "", 0, NULL);
        ...
        if (fallback_lines_seen == 0 && get_options()->UseDefaultFallbackDirs == 1) {
            /*
 ...
 */
static int
verify_and_store_outbound_address(sa_family_t family, tor_addr_t *addr, outbound_addr_t type,
                             ...
                             or_options_t *options, int validate_only, char **msg)
{
    ...
    while (lines) {
        ...
        if (verify_and_store_outbound_address(family, &addr, type, options, validate_only)) {
            if (msg)
                tor_asprintf(msg,
...
{
    if (!validate_only) {
        memset(&options->OutboundBindAddresses, 0, sizeof(options->OutboundBindAddresses));
    }

    if (parse_outbound_address_lines(options->OutboundBindAddress, OUTBOUND_ADDR_EXIT_AND_OR,
                                     options, validate_only, msg) < 0) {
        goto err;
    }

    if (parse_outbound_address_lines(options->OutboundBindAddressOR, OUTBOUND_ADDR_OR, options,
                                     validate_only, msg) < 0) {
        goto err;
    }

    if (parse_outbound_address_lines(options->OutboundBindAddressExit, OUTBOUND_ADDR_EXIT, options,
                                     validate_only, msg) < 0) {
        goto err;
    }
...
static void
config_load_geoip_file_(sa_family_t family, const char *fname, const char *default_fname)
{
    const or_options_t *options = get_options();
    const char *msg = "";
...
static void
config_maybe_load_geoip_files_(const or_options_t *options, const or_options_t *old_options)
{
...
int
init_cookie_authentication(const char *fname, const char *header, int cookie_len,
                           int group_readable, uint8_t **cookie_out, int *cookie_is_set_out)
{
...
{
    return (options->SocksPort_set || options->TransPort_set || options->NATDPort_set ||
            options->DNSPort_set || options->HTTPTunnelPort_set);
}
