...
#ifdef __GNUC__
#    define CHECK_PRINTF(formatIdx, firstArg) __attribute__((format(printf, formatIdx, firstArg)))
#else
#    define CHECK_PRINTF(formatIdx, firstArg)
#endif /* defined(__GNUC__) */
#ifdef __GNUC__
#    define CHECK_SCANF(formatIdx, firstArg) __attribute__((format(scanf, formatIdx, firstArg)))
#else
...
#        define DISABLE_GCC_WARNING(warningopt) PRAGMA_DIAGNOSTIC_(ignored warningopt)
#        define ENABLE_GCC_WARNING(warningopt) PRAGMA_DIAGNOSTIC_(warning warningopt)
