...
struct config_line_t *config_get_assigned_option(const config_mgr_t *mgr, const void *options,
                                                 const char *key, int escape_val);
int config_is_same(const config_mgr_t *fmt, const void *o1, const void *o2, const char *name);
struct config_line_t *config_get_changes(const config_mgr_t *mgr, const void *options1,
                                         const void *options2);
...
validation_status_t config_validate(const config_mgr_t *mgr, const void *old_options, void *options,
                                    char **msg_out);
void *config_dup(const config_mgr_t *mgr, const void *old);
char *config_dump(const config_mgr_t *mgr, const void *default_options, const void *options,
                  int minimal, int comment_defaults);
...
int config_assign(const config_mgr_t *mgr, void *options, struct config_line_t *list,
...
const char *config_expand_abbrev(const config_mgr_t *mgr, const char *option, int command_line,
                                 int warn_obsolete);
...
STATIC void config_reset_line(const config_mgr_t *mgr, void *options, const char *key,
                              int use_defaults);
