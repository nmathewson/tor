...
static int
string_parse(void *target, const char *value, char **errmsg, const void *params)
{
    (void)params;
    (void)errmsg;
    char **p = (char **)target;
...
static int
uint64_parse(void *target, const char *value, char **errmsg, const void *params)
{
    (void)params;
    (void)errmsg;
    uint64_t *p = target;
...
static int
units_parse_u64(void *target, const char *value, char **errmsg, const void *params)
{
    ...
    *v = config_parse_units(value, table, &ok, &msg);
    if (!ok) {
        tor_asprintf(errmsg, "Provided value is malformed or out of bounds: %s", msg);
        tor_free(msg);
        return -1;
    }
    if (BUG(msg)) {
...
static int
units_parse_int(void *target, const char *value, char **errmsg, const void *params)
{
    const unit_table_t *table = params;
    tor_assert(table);
    int *v = (int *)target;
...
static int
double_parse(void *target, const char *value, char **errmsg, const void *params)
{
    (void)params;
    (void)errmsg;
    ...
    *v = strtod(value, &endptr);
    ...
    if (errno == ERANGE) {
        ...
        tor_asprintf(errmsg, "%s is too %s to express as a floating-point number.", escaped(value),
                     underflow ? "small" : "large");
        return -1;
    }
    return 0;
}
...
static int
enum_parse(void *target, const char *value, char **errmsg, const void *params_)
{
    ...
    tor_asprintf(errmsg, "Unrecognized value %s. %s", value, params->allowed_val_string);
    return -1;
}
...
static const enumeration_params_t enum_params_bool = {"Allowed values are 0 and 1.",
                                                      enum_table_bool};
...
static const enumeration_params_t enum_params_autobool = {"Allowed values are 0, 1, and auto.",
                                                          enum_table_autobool};
...
csv_parse(void *target, const char *value, char **errmsg, const void *params)
{
    ...
    *sl = smartlist_new();
    smartlist_split_string(*sl, value, ",", SPLIT_SKIP_SPACE | SPLIT_IGNORE_BLANK, 0);
    return 0;
}
...
static int
legacy_csv_interval_parse(void *target, const char *value, char **errmsg, const void *params)
{
    (void)params;
...
static int
linelist_kv_parse(void *target, const struct config_line_t *line, char **errmsg, const void *params)
{
    (void)params;
    (void)errmsg;
...
static int
linelist_kv_virt_noparse(void *target, const struct config_line_t *line, char **errmsg,
                         const void *params)
{
    (void)target;
    (void)line;
...
static int
ignore_parse(void *target, const char *value, char **errmsg, const void *params)
{
    (void)target;
    (void)value;
    (void)errmsg;
...
const var_type_def_t FILENAME_type_defn = {.name = "Filename", .fns = &string_fns};
const var_type_def_t INT_type_defn = {
    .name = "SignedInteger", .fns = &int_fns, .params = &INT_PARSE_UNRESTRICTED};
...
const var_type_def_t MSEC_INTERVAL_type_defn = {
    .name = "TimeMsecInterval", .fns = &interval_fns, .params = &time_msec_units};
const var_type_def_t DOUBLE_type_defn = {
    .name = "Float",
    .fns = &double_fns,
};
const var_type_def_t BOOL_type_defn = {
    .name = "Boolean", .fns = &enum_fns, .params = &enum_params_bool};
const var_type_def_t AUTOBOOL_type_defn = {
    .name = "Boolean+Auto", .fns = &enum_fns, .params = &enum_params_autobool};
 ...
 */
const var_type_def_t LINELIST_S_type_defn = {.name = "Dependent",
                                             .fns = &linelist_s_fns,
...
const var_type_def_t LINELIST_V_type_defn = {
    .name = "Virtual", .fns = &linelist_v_fns, .flags = CFLG_NOREPLACE | CFLG_NOSET};
