...
#    define process_win32_free(s) FREE_AND_NULL(process_win32_t, process_win32_free_, (s))
...
STATIC bool process_win32_create_pipe(HANDLE *, HANDLE *, SECURITY_ATTRIBUTES *,
                                      process_win32_pipe_type_t);
...
STATIC bool process_win32_handle_read_completion(process_win32_handle_t *, DWORD, DWORD);
