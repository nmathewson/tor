...
MOCK_DECL_ATTR(char *, read_file_to_str, (const char *filename, int flags, struct stat *stat_out),
               ATTR_MALLOC);
 ...
 */
#    define tor_getdelim(lineptr, n, delim, stream) getdelim((lineptr), (n), (delim), (stream))
