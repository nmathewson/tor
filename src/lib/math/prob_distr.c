...
#    define DECLARE_PROB_DISTR_DOWNCAST_FN(name)                                            \
        static inline const struct name##_t *dist_to_const_##name(const struct dist_t *obj) \
        {                                                                                   \
 ...
 */
static double
sample_logistic_locscale(uint32_t s, double t, double p0, double mu, double sigma)
{
 ...
 */
static double
sample_log_logistic_scaleshape(uint32_t s, double p0, double alpha, double beta)
{
 ...
 */
static double
sample_genpareto_locscale(uint32_t s, double p0, double mu, double sigma, double xi)
{
