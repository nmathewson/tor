...
tor_mutex_uninit(tor_mutex_t *m)
{
    int err;
    raw_assert(m);
    /* If the mutex is already locked, wait until after it is unlocked to
     * destroy it. Locking and releasing the mutex makes undefined behaviour
     * less likely, but does not prevent it. Another thread can lock the mutex
