...
#define tor_evdns_add_server_port(sock, tcp, cb, data) \
    evdns_add_server_port_with_base(tor_libevent_get_base(), (sock), (tcp), (cb), (data));
...
periodic_timer_t *periodic_timer_new(struct event_base *base, const struct timeval *tv,
