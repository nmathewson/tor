...
int token_bucket_raw_refill_steps(token_bucket_raw_t *bucket, const token_bucket_cfg_t *cfg,
...
void token_bucket_rw_init(token_bucket_rw_t *bucket, uint32_t rate, uint32_t burst,
                          uint32_t now_ts);
...
static inline size_t token_bucket_rw_get_write(const token_bucket_rw_t *bucket);
static inline size_t
...
void token_bucket_ctr_init(token_bucket_ctr_t *bucket, uint32_t rate, uint32_t burst,
                           uint32_t now_ts);
