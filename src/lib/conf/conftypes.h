...
#define CFLG_GROUP_OBSOLETE \
    (CFLG_NOCOPY | CFLG_NOCMP | CFLG_NODUMP | CFLG_NOSET | CFLG_NOLIST | CFLG_WARN_OBSOLETE)

/**
 * A group of fflags that should be set on all disabled options.
 **/
#define CFLG_GROUP_DISABLED \
    (CFLG_NOCOPY | CFLG_NOCMP | CFLG_NODUMP | CFLG_NOSET | CFLG_NOLIST | CFLG_WARN_DISABLED)
