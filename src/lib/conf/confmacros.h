...
#define CONFIG_VAR_ETYPE(structtype, varname, vartype, membername, varflags, initval)              \
    {                                                                                              \
        ...
        .flags = varflags, .initvalue = initval CONF_TEST_MEMBERS(structtype, vartype, membername) \
    }
...
#define CONFIG_VAR_OBSOLETE(varname)                                                            \
    {                                                                                           \
        .member = {.name = varname, .type = CONFIG_TYPE_OBSOLETE}, .flags = CFLG_GROUP_OBSOLETE \
    }
