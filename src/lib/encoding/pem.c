 ...
 */
int
pem_encode(char *dest, size_t destlen, const uint8_t *src, size_t srclen, const char *objtype)
{
    ...
    int n = base64_encode(dest + offset, destlen - offset, (const char *)src, srclen,
