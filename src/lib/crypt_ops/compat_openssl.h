...
#    if !defined(LIBRESSL_VERSION_NUMBER) && OPENSSL_VERSION_NUMBER < OPENSSL_V_SERIES(1, 0, 1)
#        error "We require OpenSSL >= 1.0.1"
#    endif

#    if OPENSSL_VERSION_NUMBER >= OPENSSL_V_SERIES(1, 1, 0) && !defined(LIBRESSL_VERSION_NUMBER)
