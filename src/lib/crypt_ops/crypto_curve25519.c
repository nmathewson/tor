...
int
curve25519_secret_key_generate(curve25519_secret_key_t *key_out, int extra_strong)
{
 ...
 * use a better-than-usual RNG. Return 0 on success, -1 on failure. */
int
curve25519_keypair_generate(curve25519_keypair_t *keypair_out, int extra_strong)
{
...
int
curve25519_keypair_write_to_file(const curve25519_keypair_t *keypair, const char *fname,
                                 const char *tag)
{
    ...
    memcpy(contents + CURVE25519_SECKEY_LEN, keypair->pubkey.public_key, CURVE25519_PUBKEY_LEN);

    r = crypto_write_tagged_contents_to_file(fname, "c25519v1", tag, contents, sizeof(contents));
...
int
curve25519_keypair_read_from_file(curve25519_keypair_t *keypair_out, char **tag_out,
                                  const char *fname)
{
    ...
    len =
        crypto_read_tagged_contents_from_file(fname, "c25519v1", tag_out, content, sizeof(content));
    ...
    curve25519_public_key_generate(&keypair_out->pubkey, &keypair_out->seckey);
    if (tor_memneq(keypair_out->pubkey.public_key, content + CURVE25519_SECKEY_LEN,
...
{
    static const uint8_t alicesk[32] = {0x77, 0x07, 0x6d, 0x0a, 0x73, 0x18, 0xa5, 0x7d,
                                        0x3c, 0x16, 0xc1, 0x72, 0x51, 0xb2, 0x66, 0x45,
                                        0xdf, 0x4c, 0x2f, 0x87, 0xeb, 0xc0, 0x99, 0x2a,
                                        0xb1, 0x77, 0xfb, 0xa5, 0x1d, 0xb9, 0x2c, 0x2a};
    static const uint8_t alicepk[32] = {0x85, 0x20, 0xf0, 0x09, 0x89, 0x30, 0xa7, 0x54,
