...
int crypto_pk_obsolete_public_hybrid_encrypt(crypto_pk_t *env, char *to, size_t tolen,
                                             const char *from, size_t fromlen, int padding,
                                             int force);
int crypto_pk_obsolete_private_hybrid_decrypt(crypto_pk_t *env, char *to, size_t tolen,
                                              const char *from, size_t fromlen, int padding,
                                              int warnOnFailure);
int crypto_pk_public_encrypt(crypto_pk_t *env, char *to, size_t tolen, const char *from,
                             size_t fromlen, int padding);
int crypto_pk_private_decrypt(crypto_pk_t *env, char *to, size_t tolen, const char *from,
...
int crypto_pk_private_sign(const crypto_pk_t *env, char *to, size_t tolen, const char *from,
                           size_t fromlen);
...
int crypto_pk_private_sign_digest(crypto_pk_t *env, char *to, size_t tolen, const char *from,
                                  size_t fromlen);
...
MOCK_DECL(struct evp_pkey_st *, crypto_pk_get_openssl_evp_pkey_, (crypto_pk_t * env, int private));
...
const struct SECKEYPublicKeyStr *crypto_pk_get_nss_pubkey(const crypto_pk_t *key);
const struct SECKEYPrivateKeyStr *crypto_pk_get_nss_privkey(const crypto_pk_t *key);
...
#    ifdef ENABLE_NSS
struct SECItemStr;
STATIC int secitem_uint_cmp(const struct SECItemStr *a, const struct SECItemStr *b);
#    endif
