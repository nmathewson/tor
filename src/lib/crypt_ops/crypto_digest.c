...
void
crypto_mac_sha3_256(uint8_t *mac_out, size_t len_out, const uint8_t *key, size_t key_len,
                    const uint8_t *msg, size_t msg_len)
{
    ...
    crypto_digest_add_bytes(digest, (const char *)&key_len_netorder, sizeof(key_len_netorder));
...
void
crypto_xof(uint8_t *output, size_t output_len, const uint8_t *input, size_t input_len)
{
