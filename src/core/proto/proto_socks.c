                     ...
                     size_t *drain_out)
{
    ...
    if (socks_version == SOCKS_VER_4) {
        ...
        if (!req->got_auth &&
            ...
            res =
                parse_socks5_userpass_auth(raw_data, req, datalen, drain_out);
            ...
            res =
                process_socks5_client_request(req, log_sockstype, safe_socks);
                               ...
                               socks5_reply_status_t reason)
{
    ...
    ssize_t encoded = socks5_server_reply_encode(
        req->reply, sizeof(req->reply), trunnel_resp);
    if (encoded < 0) {
