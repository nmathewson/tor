    ...
    switch (type) {
        case ONION_HANDSHAKE_TYPE_TAP:
            ...
            if (onion_skin_TAP_server_handshake(
                    (const char *)onion_skin, keys->onion_key,
                    keys->last_onion_key, (char *)reply_out, (char *)keys_out,
                    keys_out_len) < 0)
                return -1;
        ...
        case ONION_HANDSHAKE_TYPE_NTOR:
                ...
                return -1;
            {
                ...
                if (onion_skin_ntor_server_handshake(
                    ...
                    /* no need to memwipe here, since the output will never be
                     * used */
                    return -1;
                }
    ...
    switch (type) {
        case ONION_HANDSHAKE_TYPE_TAP:
            ...
            if (onion_skin_TAP_client_handshake(
                    handshake_state->u.tap, (const char *)reply,
        ...
        case ONION_HANDSHAKE_TYPE_NTOR:
            ...
            }
            {
                ...
                if (onion_skin_ntor_client_handshake(
                        handshake_state->u.ntor, reply, keys_tmp, keys_tmp_len,
                        msg_out) < 0) {
                    tor_free(keys_tmp);
                    return -1;
                }
