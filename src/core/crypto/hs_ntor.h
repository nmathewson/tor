...
int
hs_ntor_client_get_introduce1_keys(const struct ed25519_public_key_t *intro_auth_pubkey,
...
int hs_ntor_circuit_key_expansion(const uint8_t *ntor_key_seed, size_t seed_len, uint8_t *keys_out,
                                  size_t keys_out_len);
