    ...
    hs_ntor_rend_cell_keys_t *hs_ntor_rend_cell_keys_out)
{
    ...
    /* Append X */
    APPEND(ptr, client_ephemeral_enc_pubkey->public_key,
           CURVE25519_PUBKEY_LEN);
    /* Append PROTOID */
...
get_introduce1_key_material(
    const uint8_t *secret_input, const hs_subcredential_t *subcredential,
    ...
    hs_ntor_rend_cell_keys_t *hs_ntor_rend_cell_keys_out)
{
    ...
    if (bad) {
        memwipe(hs_ntor_rend_cell_keys_out, 0,
                sizeof(hs_ntor_rend_cell_keys_t));
    }
    ...
    hs_ntor_intro_cell_keys_t *hs_ntor_intro_cell_keys_out)
{
    return hs_ntor_service_get_introduce1_keys_multi(
        intro_auth_pubkey, intro_enc_keypair, client_ephemeral_enc_pubkey, 1,
