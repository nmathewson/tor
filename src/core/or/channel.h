...
void channel_set_identity_digest(channel_t *chan, const char *identity_digest,
...
MOCK_DECL(ssize_t, channel_flush_some_cells, (channel_t * chan, ssize_t num_cells));
...
channel_t *channel_connect(const tor_addr_t *addr, uint16_t port, const char *rsa_id_digest,
...
#define CHANNEL_IS_CLOSED(chan) (channel_is_in_state((chan), CHANNEL_STATE_CLOSED))
#define CHANNEL_IS_OPENING(chan) (channel_is_in_state((chan), CHANNEL_STATE_OPENING))
#define CHANNEL_IS_OPEN(chan) (channel_is_in_state((chan), CHANNEL_STATE_OPEN))
#define CHANNEL_IS_MAINT(chan) (channel_is_in_state((chan), CHANNEL_STATE_MAINT))
#define CHANNEL_IS_CLOSING(chan) (channel_is_in_state((chan), CHANNEL_STATE_CLOSING))
#define CHANNEL_IS_ERROR(chan) (channel_is_in_state((chan), CHANNEL_STATE_ERROR))

#define CHANNEL_FINISHED(chan) (CHANNEL_IS_CLOSED(chan) || CHANNEL_IS_ERROR(chan))

#define CHANNEL_CONDEMNED(chan) (CHANNEL_IS_CLOSING(chan) || CHANNEL_FINISHED(chan))
