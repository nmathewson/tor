...
struct edge_connection_t {
    ...
    struct edge_connection_t *next_stream; /**< Points to the next stream at
                                            * this edge, if any */
    ...
    /* Hidden service connection identifier for edge connections. Used by the
     * HS client-side code to identify client SOCKS connections and by the
    ...
    streamid_t stream_id; /**< The stream ID used for this edge connection on
                           * its circuit */
