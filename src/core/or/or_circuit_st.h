...
struct or_circuit_t {
    ...
    /** Pointer to an entry on the onion queue, if this circuit is waiting for
     * a chance to give an onionskin to a cpuworker. Used only in onion.c */
    ...
    /** INTRODUCE2 cell bucket controlling how much can go on this circuit.
     * Only used if this is a service introduction circuit at the intro point
