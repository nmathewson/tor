...
struct or_handshake_state_t {
     ...
     * everything from the VERSIONS cell through and including the
     * AUTH_CHALLENGE cell. From the client's, we want to capture everything
     * from the VERSIONS cell through but *not* including the AUTHENTICATE
     * cell.
     *
     * @{ */
    ...
    /** Identity RSA digest that we have received and authenticated for our
