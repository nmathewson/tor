...
#define REND_BASIC_AUTH_CLIENT_ENTRY_LEN (REND_BASIC_AUTH_CLIENT_ID_LEN + CIPHER_KEY_LEN)
 ...
 */
typedef enum { CIRCUIT_N_CHAN = 0, CIRCUIT_P_CHAN = 1 } circuit_channel_direction_t;
...
{
    return wide_circ_ids ? VAR_CELL_MAX_HEADER_SIZE : VAR_CELL_MAX_HEADER_SIZE - 2;
}
