...
struct crypt_path_t {
     ...
     *    - CPATH_STATE_AWAITING_KEYS (We have sent an EXTEND/CREATE to this
     * step and not received an EXTENDED/CREATED)
...
#define CPATH_STATE_OPEN 2
    ...
    int package_window; /**< How many cells are we allowed to originate ending
                         * at this step? */
    int deliver_window; /**< How many cells are we willing to deliver
                         * originating at this step? */
