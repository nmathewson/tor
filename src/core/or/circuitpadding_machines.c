...
circpad_machine_client_hide_intro_circuits(smartlist_t *machines_sl)
{
    ...
    client_machine->states[CIRCPAD_STATE_START].next_state[CIRCPAD_EVENT_NONPADDING_SENT] =
    ...
    log_info(LD_CIRC, "Registered client intro point hiding padding machine (%u)",
...
circpad_machine_relay_hide_intro_circuits(smartlist_t *machines_sl)
{
    ...
    relay_machine->states[CIRCPAD_STATE_START].next_state[CIRCPAD_EVENT_NONPADDING_SENT] =
        CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP;
    ...
    relay_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP]
        .next_state[CIRCPAD_EVENT_PADDING_SENT] = CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP;
    ...
    relay_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP]
        .next_state[CIRCPAD_EVENT_NONPADDING_SENT] = CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP;
    ...
    relay_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].length_dist.param1 =
        INTRO_MACHINE_MINIMUM_PADDING;
    relay_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].length_dist.param2 =
     ...
     * (1, 10ms, infinity). */
    relay_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].histogram_edges[0] = 1000;
    relay_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].histogram_edges[1] = 10000;
    ...
    relay_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].histogram[0] = 1000;

    /* just one bin, so setup the total tokens */
    relay_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].histogram_total_tokens =
    ...
    log_info(LD_CIRC, "Registered relay intro circuit hiding padding machine (%u)",
...
circpad_machine_client_hide_rend_circuits(smartlist_t *machines_sl)
{
    ...
    client_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].length_dist.type =
        CIRCPAD_DIST_UNIFORM;
    client_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].length_dist.param1 = 1;
    client_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].length_dist.param2 =
        2; // rand(1,2) is always 1
    ...
    client_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].histogram_edges[0] = 0;
    client_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].histogram_edges[1] = 1000;
    ...
    client_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].histogram_total_tokens = 1;

    /* Register the machine */
    client_machine->machine_num = smartlist_len(machines_sl);
    circpad_register_padding_machine(client_machine, machines_sl);

    log_info(LD_CIRC, "Registered client rendezvous circuit hiding padding machine (%u)",
             client_machine->machine_num);
}
...
circpad_machine_relay_hide_rend_circuits(smartlist_t *machines_sl)
{
    ...
    relay_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].length_dist.type =
        CIRCPAD_DIST_UNIFORM;
    relay_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].length_dist.param1 = 1;
    relay_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].length_dist.param2 =
        2; // rand(1,2) is always 1
     ...
     * PADDING_NEGOTIATED. */
    relay_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].histogram_len = 2;
    relay_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].histogram_edges[0] = 0;
    relay_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].histogram_edges[1] = 1000;
    ...
    relay_machine->states[CIRCPAD_STATE_OBFUSCATE_CIRC_SETUP].histogram_total_tokens = 1;

    /* Register the machine */
    relay_machine->machine_num = smartlist_len(machines_sl);
    circpad_register_padding_machine(relay_machine, machines_sl);

    log_info(LD_CIRC, "Registered relay rendezvous circuit hiding padding machine (%u)",
             relay_machine->machine_num);
}
